...
def _contracts():
    ...
    c = [
        ...
        # 成交量须 ≥ |ΔOI|（物理约束：单笔成交最多使 OI 变化 ±1），
        # 否则会被"量数据不完整"判定置 r1=None，L3 不会触发
        _c("S0918C575", "2026-09-18", "call", 575, 17348, 8000, 0.87, 0.42, 0.35),
        _c("S0918C670", "2026-09-18", "call", 670, 12120, 5000, 0.49, 0.45, 0.20),
        _c("S0918P500", "2026-09-18", "put", 500, 9850, 4000, 8.10, 0.39, -0.45),
    ]
    return c
