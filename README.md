...
=======
3. **异动成交 Top（含前后对比）**：成交量/OI 异常放大的合约，附"昨量 vs 今量、放量倍数、OI 前值 vs 现值、OI 增减%"
...
=======
9. **日历（仅周二/周四早报）**：本周美国重要宏观数据（美联储会议、CPI/PPI、非农、失业率等，只列高重要性）+ 当周重要公司财报（白名单见 `config/earnings_watchlist.txt`）
>>>>>>> 346f793077584e11c3cf228e5a56cb066c7660b3
