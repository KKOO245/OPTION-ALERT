...
🔍 重点速览
🟡 **近现价集中开仓**: 09-14 367C ΔOI +1,172（距现价 +0.1%）
...
Options: P/C成交量 0.44 | OI比 0.90 | ATM IV 61.7% | Skew -3.4pp | Term 0.64 | ExpMove ±2.4%（近端） | Rank 73%
量化视角： IV 中性（Rank 73%）｜期限结构倒挂（Term 0.64，近月 IV 高于远月）｜Put 保护异常便宜（Skew -3.4pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
   ⇒ Put/Call Volume: 0.44×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.90×（两侧接近均衡）
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量接近均衡
   ExpMove 期限化（expmove_v1）: 09-14（3D）±2.4% ｜ 09-16（5D）±3.7% ｜ 09-18（7D）±4.5% ｜ 09-21（10D）±4.8%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 102,950,755 | GEX Change vs 上次快照 57,406,208 | Flip: Primary Flip: 357.17（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 100%（带内） ｜ IV 有效性: VALID 1287 / LOW 140 / INVALID 571
结构观察区: Primary Flip 357.17（全链重定价，覆盖 100%）
Call Wall 400（现价低于该位 8.2%）
最近结构参考: Flip 357（现价高于该位 2.8%）
量化视角： 正 Gamma（1.03亿，无历史分位）｜正 Gamma 增强（+5741万）｜现价位于 Flip 上方 2.78%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
平值价格ATM:  C 4.00 / P 4.92
隐含波动率 ATM IV:  31.9%
净 delta 敞口变化 ΔOI Δ Exposure*: 184k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 400 ｜ +4,219 ｜ $0.10 ｜ 名义 $42.2k* ｜ +9.0%
C 367 ｜ +1,172 ｜ $4.00 ｜ 名义 $468.8k* ｜ +0.1%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：400（+9.0%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 365（结算参考） ｜ Call Wall 400（+9.0%）（OI 7.0k）
量化解读： 存量 Call 重｜ATM IV 31.9%｜历史 Rank 73%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 184,347 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-16 Forward Structure
存量OI:      C 16.7k / P 10.7k
今日变化ΔOI: C +5.1k / P +2.7k
平值价格ATM:  C 6.30 / P 7.15
隐含波动率 ATM IV:  38.1%
净 delta 敞口变化 ΔOI Δ Exposure*: 25k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 400 ｜ +1,342 ｜ $0.40 ｜ 名义 $53.7k* ｜ +9.0%
P 340 ｜ +599 ｜ $0.54 ｜ 名义 $32.3k* ｜ -7.4%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：400（+9.0%） / 340（-7.4%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 362（结算参考） ｜ Call Wall 400（+9.0%，弱）（OI 2.3k） ｜ Put Wall 340（-7.4%，弱）（OI 1.3k）
量化解读： 存量 Call 重｜ATM IV 38.1%｜历史 Rank 73%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 25,319 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-18 Forward Structure
存量OI:      C 512.5k / P 400.2k
今日变化ΔOI: C +25.0k / P -16.0k
平值价格ATM:  C 8.00 / P 8.62
隐含波动率 ATM IV:  39.9%
净 delta 敞口变化 ΔOI Δ Exposure*: 2.0M shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 440 ｜ -6,194 ｜ $74.19 ｜ 名义 $-45.95M* ｜ +19.9%
P 340 ｜ -3,838 ｜ $1.04 ｜ 名义 $-399.2k* ｜ -7.4%
P 290 ｜ -3,421 ｜ $0.15 ｜ 名义 $-51.3k* ｜ -21.0%
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 360（结算参考）
量化解读： 存量 Call 重｜ATM IV 39.9%｜历史 Rank 73%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 2,011,924 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-21 Forward Structure
存量OI:      C 4.1k / P 3.7k
今日变化ΔOI: C +1.0k / P +1.2k
平值价格ATM:  C 8.75 / P 9.00
隐含波动率 ATM IV:  36.8%
净 delta 敞口变化 ΔOI Δ Exposure*: 8k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 345 ｜ +555 ｜ $1.90 ｜ 名义 $105.5k* ｜ -6.0%
C 380 ｜ +499 ｜ $4.93 ｜ 名义 $246.0k* ｜ +3.5%
C 390 ｜ -248 ｜ $2.19 ｜ 名义 $-54.3k* ｜ +6.2%
结构参考：380（+3.5%） / 345（-6.0%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 365（结算参考） ｜ Call Wall 380（+3.5%，弱）（OI 0.8k） ｜ Put Wall 345（-6.0%）（OI 0.6k）
量化解读： 存量两侧均衡｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 36.8%｜历史 Rank 73%（近端代理）｜净 delta 敞口 正 8,083 股（方向不可观测）——方向不可观测，观察点，非方向信号
