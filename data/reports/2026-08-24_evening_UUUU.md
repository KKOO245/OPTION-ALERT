...
UUUU: 今晨 14.79 → 收盘 14.78（-0.1%）
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞


## UUUU

Options: P/C量 0.37 | OI比 0.60 | ATM IV 83.7% | Skew -3.8pp | Term 0.90 | ExpMove ±7.2% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.37×（Call 成交高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.60×（Put OI 低于 Call OI）→ 存量 Call-dominant
   ⇒ 两者结构一致
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma: POSITIVE | GEX(存量) N/A | GEX Change N/A | Flip: ≈6.65 / ≈9.01 / ≈14.60
结构观察区: 7–9（局部 Gamma 切换，低置信；Top-3 近似，需全链重定价验证）
距 Put Wall 11: +34.4% | 距 Call Wall 18: -17.9%
🧭 结构解读（全部依赖上方假设）
