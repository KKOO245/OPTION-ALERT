...
SOXX  昨收 519.52 → 今晨 501.09（-3.5%） | 较昨收变动（含盘初走势）


## SOXX

Options: P/C量 2.52 | OI比 0.73 | ATM IV 51.4% | Skew 2.3pp | Term 0.83 | ExpMove ±4.4% | Rank — (历史不足)
   ⇒ Put/Call Volume: 2.52×（Put 成交显著高于 Call）→ 方向 Unknown
...
距 Put Wall 500: +0.2% | 距 Call Wall 670: -25.2%
🧭 结构解读（全部依赖上方假设）
