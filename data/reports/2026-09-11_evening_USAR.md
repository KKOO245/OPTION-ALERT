...
🟡 **单日价格波动**: -2.9%（vs 前收盘）
   ⇒ 价格变动超阈值；纯事实，不解释方向
🟡 **近现价集中开仓**: 09-25 15P ΔOI +159（距现价 -3.6%）
...
平值价格ATM:  C 0.57 / P 0.58
隐含波动率 ATM IV:  67.5%
净 delta 敞口变化 ΔOI Δ Exposure*: 218k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 25 ｜ -2,820 ｜ $8.85 ｜ 名义 $-2.50M* ｜ +60.7%
P 17 ｜ +1,103 ｜ $1.59 ｜ 名义 $175.4k* ｜ +9.3%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：17（+9.3%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 19（结算参考） ｜ Put Wall 15（-3.6%，弱）（OI 8.8k）
量化解读： 存量 Call 重｜ATM IV 67.5%｜历史 Rank 91%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 218,317 股（方向不可观测）——方向不可观测，观察点，非方向信号

09-25（MEDIUM △）Top ΔOI: 15P +159 ｜ 16C +112
09-25（MEDIUM △）仓位参考: Max Pain 18（结算参考） ｜ Put Wall 15（-3.6%）（OI 0.8k）

📆 10-02 Forward Structure
存量OI:      C 7.6k / P 2.8k
今日变化ΔOI: C +0.2k / P +0.2k
平值价格ATM:  C 1.19 / P 1.02
隐含波动率 ATM IV:  74.6%
净 delta 敞口变化 ΔOI Δ Exposure*: -996 shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 17 ｜ +48 ｜ $1.93 ｜ 名义 $9.3k* ｜ +9.3%
P 14 ｜ +35 ｜ $0.38 ｜ 名义 $1.3k* ｜ -10.0%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：17（+9.3%） / 14（-10.0%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 18（结算参考）
量化解读： 存量 Call 重｜ATM IV 74.6%｜历史 Rank 91%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 996 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 10-09 Forward Structure
存量OI:      C 4.0k / P 2.2k
今日变化ΔOI: C +50 / P +0.3k
平值价格ATM:  C 1.60 / P 1.25
隐含波动率 ATM IV:  74.2%
净 delta 敞口变化 ΔOI Δ Exposure*: -12k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 15 ｜ +111 ｜ $0.97 ｜ 名义 $10.8k* ｜ -3.6%
P 14 ｜ +73 ｜ $0.70 ｜ 名义 $5.1k* ｜ -6.8%
P 16 ｜ +43 ｜ $1.52 ｜ 名义 $6.5k* ｜ +2.8%
结构参考：16（+2.8%） / 15（-3.6%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 18（结算参考） ｜ Put Wall 16（+2.8%）（OI 1.2k）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 74.2%｜历史 Rank 91%（近端代理）｜净 delta 敞口 负 11,587 股（方向不可观测）——方向不可观测，观察点，非方向信号
