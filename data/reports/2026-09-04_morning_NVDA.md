...
🟡 **单日价格波动**: +2.4%（vs 前收盘）
   ⇒ 价格变动超阈值；纯事实，不解释方向
🟡 **近现价集中开仓**: 09-09 240C ΔOI +6,217（距现价 +2.6%）
...
NVDA  昨收 228.45 → 今开 231.14（+1.2%） | 较昨收变动（含盘初走势） ｜ 今日高 234.65 ｜ 低 229.82

Options: P/C成交量 0.29 | OI比 1.12 | ATM IV 50.8% | Skew -2.8pp | Term 0.66 | ExpMove ±2.6%（近端） | Rank 72%
量化视角： IV 中性（Rank 72%）｜期限结构倒挂（Term 0.66，近月 IV 高于远月）｜Put 保护异常便宜（Skew -2.8pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
   ⇒ Put/Call Volume: 0.29×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 1.12×（两侧接近均衡）
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量接近均衡
   ExpMove 期限化（expmove_v1）: 09-09（5D）±2.6% ｜ 09-11（7D）±3.6% ｜ 09-14（10D）±4.0% ｜ 09-16（12D）±4.6%
   ⇒ IV–VIX Spread: +36.8pp*（*近月 ATM IV − VIX；期限未对齐，仅作相对波动率 Proxy，不直接代表期权定价贵/便宜）
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 855,464,953 | GEX Change vs 上次快照 141,661,998 | Flip: Primary Flip: 214.54（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 98%（带内） ｜ IV 有效性: VALID 643 / LOW 125 / INVALID 370
结构观察区: Primary Flip 214.54（全链重定价，覆盖 98%）
Call Wall 230（弱结构｜现价高于该位 1.7%）
最近结构参考: Call Wall 230（现价高于该位 1.7%）
量化视角： 正 Gamma（8.55亿，无历史分位）｜正 Gamma 增强（+1.42亿）｜现价位于 Flip 上方 9.06%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
平值价格ATM:  C 2.59 / P 3.60
隐含波动率 ATM IV:  27.5%
净 delta 敞口变化 ΔOI Δ Exposure*: 890k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 240 ｜ +6,217 ｜ $1.03 ｜ 名义 $640.4k* ｜ +2.6%
C 230 ｜ +5,740 ｜ $5.50 ｜ 名义 $3.16M* ｜ -1.7%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：240（+2.6%） / 230（-1.7%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 27.5%｜历史 Rank 72%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 889,913 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-11 Forward Structure
存量OI:      C 282.8k / P 177.1k
今日变化ΔOI: C +62.5k / P +51.7k
平值价格ATM:  C 3.65 / P 4.89
隐含波动率 ATM IV:  31.6%
净 delta 敞口变化 ΔOI Δ Exposure*: 2.2M shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 240 ｜ +16,690 ｜ $1.84 ｜ 名义 $3.07M* ｜ +2.6%
C 232 ｜ +12,649 ｜ $4.88 ｜ 名义 $6.17M* ｜ -0.6%
P 170 ｜ +8,373 ｜ $0.06 ｜ 名义 $50.2k* ｜ -27.3%
结构参考：240（+2.6%） / 232（-0.6%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 31.6%｜历史 Rank 72%（近端代理）｜净 delta 敞口 正 2,162,714 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-14 Forward Structure
存量OI:      C 16.4k / P 5.1k
今日变化ΔOI: C +1.5k / P +1.2k
平值价格ATM:  C 4.09 / P 5.25
隐含波动率 ATM IV:  29.9%
净 delta 敞口变化 ΔOI Δ Exposure*: 11k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 250 ｜ +718 ｜ $0.62 ｜ 名义 $44.5k* ｜ +6.8%
P 220 ｜ +395 ｜ $0.85 ｜ 名义 $33.6k* ｜ -6.0%
C 235 ｜ +331 ｜ $4.09 ｜ 名义 $135.4k* ｜ +0.4%
结构参考：250（+6.8%） / 220（-6.0%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 29.9%｜历史 Rank 72%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 10,708 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-16 Forward Structure
存量OI:      C 9.3k / P 4.1k
今日变化ΔOI: C +2.1k / P +1.1k
平值价格ATM:  C 4.80 / P 6.03
隐含波动率 ATM IV:  31.7%
净 delta 敞口变化 ΔOI Δ Exposure*: 66k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 230 ｜ +376 ｜ $7.55 ｜ 名义 $283.9k* ｜ -1.7%
C 245 ｜ +348 ｜ $1.72 ｜ 名义 $59.9k* ｜ +4.7%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：245（+4.7%） / 230（-1.7%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 31.7%｜历史 Rank 72%（近端代理）｜净 delta 敞口 正 66,473 股（方向不可观测）——方向不可观测，观察点，非方向信号
