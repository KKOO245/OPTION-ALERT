...
Options: P/C量 0.74 | OI比 0.97 | ATM IV 100.4% | Skew -1.7pp | Term 0.91 | ExpMove ±8.5% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.74×（Call 成交高于 Put）→ 方向 Unknown
...
距 Put Wall 200: +5.2% | 距 Call Wall 250: -15.8%
🧭 结构解读（全部依赖上方假设）
