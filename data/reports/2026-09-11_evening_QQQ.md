...
存量OI: C 42.5k / P 87.5k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $2.52 / P $2.65 ｜ ATM IV 9.9%，净 delta 敞口 0 shares
仓位参考: Max Pain 711 ｜ Call Wall 730（+2.1%）（OI 8.3k） ｜ Put Wall 655（-8.4%）（OI 11.9k）
量化解读： 存量 Put 重｜ATM IV 9.9%｜历史 Rank 2%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 0 股

09-15（Activity LOW）仓位参考: Max Pain 715 ｜ Call Wall 730（+2.1%，弱）（OI 5.2k） ｜ Put Wall 650（-9.1%）（OI 15.7k）

09-16（Activity LOW）仓位参考: Max Pain 710 ｜ Call Wall 740（+3.5%，弱）（OI 2.0k） ｜ Put Wall 677（-5.3%）（OI 3.4k）

09-17（Activity LOW）仓位参考: Max Pain 710 ｜ Call Wall 725（+1.4%）（OI 1.7k） ｜ Put Wall 690（-3.5%，弱）（OI 1.7k）
