...
🔍 重点速览
🟡 **近现价集中开仓**: 09-11 150C ΔOI +12,090（距现价 +5.0%）
...
C 150 ｜ +12,090 ｜ $3.10 ｜ 名义 $3.75M* ｜ +5.0%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：150（+5.0%）附近形成 OI 变化集中（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 200 ｜ +2,266 ｜ $0.55 ｜ 名义 $124.6k* ｜ +40.1%
C 165 ｜ +1,878 ｜ $2.56 ｜ 名义 $480.8k* ｜ +15.5%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：200（+40.1%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 160 ｜ +615 ｜ $4.85 ｜ 名义 $298.3k* ｜ +12.0%
C 145 ｜ +590 ｜ $9.55 ｜ 名义 $563.5k* ｜ +1.5%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：160（+12.0%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 125（结算参考） ｜ Call Wall 140（-2.0%，弱）（OI 1.4k）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 145 ｜ +2,332 ｜ $10.80 ｜ 名义 $2.52M* ｜ +1.5%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：145（+1.5%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 128（结算参考） ｜ Call Wall 145（+1.5%，弱）（OI 2.6k）
