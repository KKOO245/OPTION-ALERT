...
CCO: 今晨 2.38 → 收盘 2.39（+0.2%） ｜ 今日高 2.39 ｜ 低 2.38
...
距 Put Wall 2: +19.5% | 距 Call Wall 3: -20.3%
最近结构参考: Flip 2（距现价 +8.6%）
🧭 结构解读（全部依赖上方假设）
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-27/CCO_evening.json