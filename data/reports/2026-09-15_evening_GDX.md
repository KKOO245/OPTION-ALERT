...
存量OI: C 340.9k / P 439.8k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $1.99 / P $1.88 ｜ ATM IV 57.1%，净 delta 敞口 0 shares
仓位参考: Max Pain 92 ｜ Call Wall 100（+6.2%，弱）（OI 30.8k） ｜ Put Wall 90（-4.4%，弱）（OI 43.0k）
量化解读： 存量 Put 重｜ATM IV 57.1%｜历史 Rank 91%（近端代理）｜IV/RV 1.54×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

09-25（Activity LOW）仓位参考: Max Pain 95 ｜ Call Wall 100（+6.2%，弱）（OI 3.8k） ｜ Put Wall 93（-1.2%，弱）（OI 3.8k）

10-02（Activity LOW）仓位参考: Max Pain 99 ｜ Call Wall 100（+6.2%，弱）（OI 2.9k） ｜ Put Wall 97（+3.0%）（OI 11.3k）

10-09（Activity LOW）仓位参考: Max Pain 98 ｜ Call Wall 85（-9.7%）（OI 0.2k） ｜ Put Wall 85（-9.7%，弱）（OI 0.4k）
