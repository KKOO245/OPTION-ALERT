...
🔍 重点速览
🟡 **近现价集中开仓**: 10-16 370C ΔOI +50（距现价 -4.7%）
...
Options: P/C成交量 0.30 | OI比 0.92 | ATM IV 98.1% | Skew 30.7pp | Term 0.35 | ExpMove ±5.3%（近端） | Rank 100%
量化视角： IV 历史高位（Rank 100%，期权偏贵）｜期限结构倒挂（Term 0.35，近月 IV 高于远月）｜保护溢价显著（Skew 30.7pp，Put 明显贵于 Call）｜当日成交与存量接近均衡——观察点，非方向信号
   ⇒ Put/Call Volume: 0.30×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.92×（两侧接近均衡）
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量接近均衡
   ExpMove 期限化（expmove_v1）: 09-25（7D）±5.3% ｜ 10-02（14D）±2.1% ｜ 10-09（21D）±9.7% ｜ 10-16（28D）±7.3%
   ⇒ IV–VIX Spread: +82.6pp*（*近月 ATM IV − VIX；期限未对齐，仅作相对波动率 Proxy，不直接代表期权定价贵/便宜）
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 918,177 | GEX Change vs 上次快照 -310,401 | Flip: Candidates 375.72 ｜ Primary: N/A（CONDITIONAL）
...
Put Wall 350（弱结构｜现价高于该位 10.9%） | Call Wall 400（弱结构｜现价低于该位 3.0%）
最近结构参考: Call Wall 400（现价低于该位 3.0%）
量化视角： 正 Gamma（92万，无历史分位）｜正 Gamma 减弱（31万）｜⚠️ 重点观察：正 Gamma 由正转负（结构切换）——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
🎯 今日到期（0DTE）
存量OI: C 16.3k / P 15.0k，今日成交量: C 0 / P 3，平值价格ATM: C $2.10 / P $7.00 ｜ ATM IV 98.1%，预期波动 ±2.3%，Max Pain 372
...
存量OI: C 1.7k / P 0.9k，今日变化ΔOI: C +53 / P +0.1k，平值价格ATM: C $6.50 / P $14.07 ｜ ATM IV 33.0%，净 delta 敞口 669 shares
Top ΔOI: P 360 +51 ｜ C 400 +27
仓位参考: Max Pain 370 ｜ Call Wall 405（+4.3%，弱）（OI 0.2k） ｜ Put Wall 360（-7.2%）（OI 0.2k）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 33.0%｜历史 Rank 100%（近端代理）｜净 delta 敞口 正 669 股

10-02（MEDIUM △）Top ΔOI: 407C +24 ｜ 420C +20
10-02（MEDIUM △）仓位参考: Max Pain 365 ｜ Call Wall 405（+4.3%，弱）（OI 79）

10-09（Activity LOW）仓位参考: Max Pain 380 ｜ Call Wall 380（-2.1%）（OI 0.1k） ｜ Put Wall 385（-0.8%）（OI 0.2k）

10-16（Activity LOW）仓位参考: Max Pain 385 ｜ Call Wall 400（+3.1%，弱）（OI 0.5k） ｜ Put Wall 350（-9.8%，弱）（OI 1.1k）
