...
🟡 **近现价集中开仓**: 09-04 18C ΔOI +244（距现价 +0.2%）
...
Options: P/C成交量 0.24 | OI比 0.30 | ATM IV 94.3% | Skew -1.3pp | Term 0.85 | ExpMove ±4.8%（近端） | Rank 12%
量化视角： IV 历史低位（Rank 12%，期权偏便宜）｜期限结构倒挂（Term 0.85，近月 IV 高于远月）｜Put 保护异常便宜（Skew -1.3pp，Put IV < Call IV）｜存量 Call 偏重（OI比 0.30）——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-04（1D）±4.8% ｜ 09-11（8D）±9.0% ｜ 09-18（15D）±12.4% ｜ 09-25（22D）±15.4%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 6,953,249 | GEX Change vs 上次快照 860,079 | Flip: Primary Flip: 17.25（PRIMARY，全链重定价 + 覆盖达标）
...
最近结构参考: Flip 17（现价高于该位 4.2%）
量化视角： 正 Gamma（695万，无历史分位）｜正 Gamma 增强（+86万）｜现价位于 Flip 上方 4.19%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
C 19 ｜ +465 ｜ $0.09 ｜ 名义 $4.2k* ｜ +5.7%
C 18 ｜ +244 ｜ $0.39 ｜ 名义 $9.5k* ｜ +0.2%
P 16 ｜ -95 ｜ $0.04 ｜ 名义 $-380* ｜ -8.2%
结构参考：19（+5.7%）附近形成 OI 变化集中（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 19 ｜ +2,061 ｜ $0.30 ｜ 名义 $61.8k* ｜ +8.5%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：19（+8.5%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
