...
🟡 **近现价集中开仓**: 09-18 235C ΔOI +3,446（距现价 +4.7%）
...
10-02  C +0.2k / P +0.4k ｜ Activity HIGH ｜ 21D
10-09  C +0.3k / P +0.9k ｜ Activity HIGH ｜ 28D

📆 09-18 Forward Structure
存量OI:      C 130.0k / P 168.3k
今日变化ΔOI: C +10.8k / P +2.7k
平值价格ATM:  C 8.85 / P 9.22
隐含波动率 ATM IV:  72.5%
净 delta 敞口变化 ΔOI Δ Exposure*: 413k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 235 ｜ +3,446 ｜ $5.05 ｜ 名义 $1.74M* ｜ +4.7%
C 227 ｜ +2,728 ｜ $7.75 ｜ 名义 $2.11M* ｜ +1.3%
C 197 ｜ +1,810 ｜ $33.50 ｜ 名义 $6.06M* ｜ -12.0%
结构参考：235（+4.7%） / 197（-12.0%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 220（结算参考）
量化解读： 存量 Put 重｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 72.5%｜历史 Rank 22%（近端代理）｜净 delta 敞口 正 412,928 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-25 Forward Structure
存量OI:      C 13.0k / P 16.1k
今日变化ΔOI: C +0.3k / P +0.5k
平值价格ATM:  C 12.85 / P 13.25
隐含波动率 ATM IV:  73.8%
净 delta 敞口变化 ΔOI Δ Exposure*: -4k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 200 ｜ +145 ｜ $3.65 ｜ 名义 $52.9k* ｜ -10.9%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：200（-10.9%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 220（结算参考）
量化解读： 存量 Put 重｜ATM IV 73.8%｜历史 Rank 22%（近端代理）｜净 delta 敞口 负 3,663 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 10-02 Forward Structure
存量OI:      C 6.9k / P 9.4k
今日变化ΔOI: C +0.2k / P +0.4k
平值价格ATM:  C 16.23 / P 16.24
隐含波动率 ATM IV:  77.2%
净 delta 敞口变化 ΔOI Δ Exposure*: -1k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 210 ｜ +69 ｜ $9.50 ｜ 名义 $65.5k* ｜ -6.5%
C 250 ｜ +67 ｜ $7.82 ｜ 名义 $52.4k* ｜ +11.3%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：250（+11.3%） / 210（-6.5%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 220（结算参考）
量化解读： 存量 Put 重｜ATM IV 77.2%｜历史 Rank 22%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 1,173 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 10-09 Forward Structure
存量OI:      C 3.6k / P 5.0k
今日变化ΔOI: C +0.3k / P +0.9k
平值价格ATM:  C 19.53 / P 18.53
隐含波动率 ATM IV:  75.7%
净 delta 敞口变化 ΔOI Δ Exposure*: -879 shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 235 ｜ +206 ｜ $15.29 ｜ 名义 $315.0k* ｜ +4.7%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：235（+4.7%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 230（结算参考）
量化解读： 存量 Put 重｜ATM IV 75.7%｜历史 Rank 22%（近端代理）｜净 delta 敞口 负 879 股（方向不可观测）——方向不可观测，观察点，非方向信号
