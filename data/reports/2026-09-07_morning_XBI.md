...
XBI  昨收 163.81 → 今开 162.74（-0.7%） | 较昨收变动（含盘初走势） ｜ 今日高 164.35 ｜ 低 162.51

Options: P/C成交量 1.11 | OI比 1.80 | ATM IV 26.5% | Skew 2.6pp | Term 1.13 | ExpMove ±2.9% | Rank 13%
...
Gamma Regime: NEGATIVE（模型分类） | GEX(存量) -9,825,539 | GEX Change vs 上次快照 nan | Flip: Primary Flip: 165.43（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 负 Gamma（983万，无历史分位）｜GEX 变化（nan万）｜现价位于 Flip 下方 0.98%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-07/XBI_morning.json