...
Options: P/C成交量 0.51 | OI比 0.88 | ATM IV 54.0% | Skew -0.6pp | Term 0.89 | ExpMove ±3.9%（近端） | Rank 27%
量化视角： IV 中性（Rank 27%）｜期限结构倒挂（Term 0.89，近月 IV 高于远月）｜Put 保护异常便宜（Skew -0.6pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 44,350,014 | GEX Change vs 上次快照 4,980,960 | Flip: Primary Flip: 151.66（PRIMARY，全链重定价 + 覆盖达标）
...
最近结构参考: Flip 152（现价高于该位 2.0%）
量化视角： 正 Gamma（4435万，无历史分位）｜正 Gamma 增强（+498万）｜现价位于 Flip 上方 2.02%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
量化解读： 存量两侧均衡｜ATM IV 54.0%｜历史 Rank 27%（近端代理）｜IV/RV 1.16×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

10-02（Activity LOW）仓位参考: Max Pain 150 ｜ Call Wall 170（+9.9%，弱）（OI 8.3k） ｜ Put Wall 150（-3.1%，弱）（OI 4.2k）

10-09（Activity LOW）仓位参考: Max Pain 149 ｜ Call Wall 160（+3.4%，弱）（OI 2.5k） ｜ Put Wall 140（-9.5%，弱）（OI 1.5k）

10-16（Activity LOW）仓位参考: Max Pain 150 ｜ Call Wall 160（+3.4%，弱）（OI 35.2k） ｜ Put Wall 155（+0.2%，弱）（OI 49.6k）
