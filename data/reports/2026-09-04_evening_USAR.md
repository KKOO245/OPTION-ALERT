...
🔍 重点速览
🟡 **近现价集中开仓**: 09-11 17P ΔOI +447（距现价 -3.5%）
...
USAR: 今开 18.65 → 收盘 17.61（-5.6%） ｜ 今日高 19.30 ｜ 低 17.25
...
09-18  C +1.2k / P -0.6k ｜ Activity MEDIUM △ ｜ 14D
...
P 17 ｜ +447 ｜ $0.39 ｜ 名义 $17.4k* ｜ -3.5%
C 19 ｜ +167 ｜ $0.24 ｜ 名义 $4.0k* ｜ +7.9%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：19（+7.9%） / 17（-3.5%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 67.2%｜历史 Rank 73%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 负 22,177 股（方向不可观测）——方向不可观测，观察点，非方向信号

09-18（MEDIUM △）Top ΔOI: 18P -305
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 23 ｜ +4,029 ｜ $0.25 ｜ 名义 $100.7k* ｜ +30.6%
C 18 ｜ +84 ｜ $1.39 ｜ 名义 $11.7k* ｜ +2.2%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：23（+30.6%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 81.1%｜历史 Rank 73%（近端代理）｜净 delta 敞口 正 68,729 股（方向不可观测）——方向不可观测，观察点，非方向信号
