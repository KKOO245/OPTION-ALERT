...
量化视角： IV 历史低位（Rank 23%，期权偏便宜）｜期限结构倒挂（Term 0.83，近月 IV 高于远月）｜保护溢价薄（Skew 1.6pp）｜存量 Call 偏重（OI比 0.44）——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-25（3D）±8.7% ｜ 10-02（10D）±11.4% ｜ 10-09（17D）±13.1% ｜ 10-16（24D）±17.0%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 2,567,299 | GEX Change vs 上次快照 871,042 | Flip: Primary Flip: 15.54（PRIMARY，全链重定价 + 覆盖达标）
...
最近结构参考: Flip 16（现价高于该位 11.5%）
量化视角： 正 Gamma（257万，无历史分位）｜正 Gamma 增强（+87万）｜现价位于 Flip 上方 11.48%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
10-02（Activity LOW）仓位参考: Max Pain 18 ｜ Put Wall 18.5（+6.8%，弱）（OI 0.1k）

10-09（Activity LOW）仓位参考: Max Pain 18 ｜ Put Wall 16（-7.6%）（OI 0.1k）

10-16（Activity LOW）仓位参考: Max Pain 20 ｜ Put Wall 17（-1.8%，弱）（OI 0.7k）

📅 事件差分（观察，非因果）: 09-25（3D）ATM IV 92.1% vs 10-02 81.3%（差 +10.7pp）——覆盖 President Trump and President Xi Summit、耐用品订单 Orders MoM
