...
🔍 重点速览
🟡 **近现价集中开仓**: 09-14 745P ΔOI +9,888（距现价 -2.5%）
...
平值价格ATM:  C 2.19 / P 1.78
隐含波动率 ATM IV:  7.1%
净 delta 敞口变化 ΔOI Δ Exposure*: 1.4M shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 745 ｜ +9,888 ｜ $0.09 ｜ 名义 $89.0k* ｜ -2.5%
P 700 ｜ -4,021 ｜ $0.03 ｜ 名义 $-12.1k* ｜ -8.4%
P 730 ｜ +3,906 ｜ $0.06 ｜ 名义 $23.4k* ｜ -4.5%
结构参考：745（-2.5%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 759（结算参考） ｜ Call Wall 765（+0.1%，弱）（OI 6.9k） ｜ Put Wall 700（-8.4%）（OI 20.1k）
量化解读： 存量 Put 重｜ATM IV 7.1%｜历史 Rank 16%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 1,377,205 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-15 Forward Structure
存量OI:      C 32.4k / P 102.2k
今日变化ΔOI: C +15.1k / P +39.5k
平值价格ATM:  C 2.99 / P 2.47
隐含波动率 ATM IV:  8.5%
净 delta 敞口变化 ΔOI Δ Exposure*: 546k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 742 ｜ +15,420 ｜ $0.19 ｜ 名义 $293.0k* ｜ -2.9%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：742（-2.9%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 760（结算参考） ｜ Call Wall 770（+0.7%，弱）（OI 4.8k） ｜ Put Wall 760（-0.6%，弱）（OI 22.0k）
量化解读： 存量 Put 重｜ATM IV 8.5%｜历史 Rank 16%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 546,316 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-16 Forward Structure
存量OI:      C 25.1k / P 28.2k
今日变化ΔOI: C +11.5k / P +10.0k
平值价格ATM:  C 4.14 / P 3.59
隐含波动率 ATM IV:  10.8%
净 delta 敞口变化 ΔOI Δ Exposure*: 289k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 722 ｜ +2,519 ｜ $0.13 ｜ 名义 $32.7k* ｜ -5.5%
C 779 ｜ +1,843 ｜ $0.11 ｜ 名义 $20.3k* ｜ +1.9%
C 799 ｜ +1,518 ｜ $0.01 ｜ 名义 $1.5k* ｜ +4.5%
结构参考：779（+1.9%） / 722（-5.5%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 760（结算参考） ｜ Call Wall 770（+0.7%）（OI 2.8k） ｜ Put Wall 735（-3.8%，弱）（OI 2.7k）
量化解读： 存量两侧均衡｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 10.8%｜历史 Rank 16%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 288,908 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-17 Forward Structure
存量OI:      C 29.0k / P 26.5k
今日变化ΔOI: C +17.8k / P +11.6k
平值价格ATM:  C 4.95 / P 4.31
隐含波动率 ATM IV:  11.6%
净 delta 敞口变化 ΔOI Δ Exposure*: 281k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 791 ｜ +2,300 ｜ $0.05 ｜ 名义 $11.5k* ｜ +3.5%
C 840 ｜ +1,593 ｜ $0.01 ｜ 名义 $1.6k* ｜ +9.9%
C 779 ｜ +1,489 ｜ $0.26 ｜ 名义 $38.7k* ｜ +1.9%
结构参考：791（+3.5%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 760（结算参考） ｜ Call Wall 775（+1.4%，弱）（OI 2.6k） ｜ Put Wall 745（-2.5%）（OI 4.3k）
量化解读： 存量两侧均衡｜ATM IV 11.6%｜历史 Rank 16%（近端代理）｜净 delta 敞口 正 280,540 股（方向不可观测）——方向不可观测，观察点，非方向信号
