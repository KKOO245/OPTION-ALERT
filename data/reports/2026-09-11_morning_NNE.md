...
🔍 重点速览
🟡 **近现价集中开仓**: 09-18 17P ΔOI +67（距现价 -1.4%）
...
Options: P/C成交量 2.68 | OI比 0.63 | ATM IV 109.2% | Skew -0.8pp | Term 0.73 | ExpMove ±15.5%（近端） | Rank 49%
量化视角： IV 中性（Rank 49%）｜期限结构倒挂（Term 0.73，近月 IV 高于远月）｜Put 保护异常便宜（Skew -0.8pp，Put IV < Call IV）｜⚠️ 重点观察：存量 Call 重（OI比 0.63）+ 当日成交偏 Put（P/C量 2.68）——结构背离，买/卖方向不可观测——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-18（7D）±15.5% ｜ 09-25（14D）±15.9% ｜ 10-02（21D）±19.7% ｜ 10-09（28D）±23.1%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 706,749 | GEX Change vs 上次快照 96,660 | Flip: Primary Flip: 16.81（PRIMARY，全链重定价 + 覆盖达标）
...
Put Wall 16（弱结构｜现价高于该位 7.8%）
最近结构参考: Flip 17（现价高于该位 2.6%）
量化视角： 正 Gamma（71万，无历史分位）｜正 Gamma 增强（+10万）｜现价位于 Flip 上方 2.62%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
平值价格ATM:  C 2.07 / P 0.60
隐含波动率 ATM IV:  79.8%
净 delta 敞口变化 ΔOI Δ Exposure*: -2k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 16 ｜ +167 ｜ $0.30 ｜ 名义 $5.0k* ｜ -7.2%
P 17 ｜ +67 ｜ $0.60 ｜ 名义 $4.0k* ｜ -1.4%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：16（-7.2%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 19（结算参考） ｜ Put Wall 18（+4.3%，弱）（OI 0.7k）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 79.8%｜历史 Rank 49%（近端代理）｜净 delta 敞口 负 2,408 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-25 Forward Structure
存量OI:      C 4.8k / P 1.1k
今日变化ΔOI: C +34 / P +91
平值价格ATM:  C 1.85 / P 0.90
隐含波动率 ATM IV:  84.7%
净 delta 敞口变化 ΔOI Δ Exposure*: -3k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 17 ｜ +25 ｜ $1.10 ｜ 名义 $2.8k* ｜ +1.4%
P 16 ｜ +17 ｜ $0.49 ｜ 名义 $833* ｜ -7.2%
P 18 ｜ +17 ｜ $1.75 ｜ 名义 $3.0k* ｜ +7.2%
结构参考：17（+1.4%） / 16（-7.2%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 19（结算参考）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 84.7%｜历史 Rank 49%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 3,088 股（方向不可观测）——方向不可观测，观察点，非方向信号

10-02（Activity LOW）仓位参考: Max Pain 19（结算参考） ｜ Put Wall 18.5（+7.2%，弱）（OI 0.1k）

📆 10-09 Forward Structure
存量OI:      C 4.1k / P 0.2k
今日变化ΔOI: C +44 / P +86
平值价格ATM:  C 2.71 / P 1.28
隐含波动率 ATM IV:  80.0%
净 delta 敞口变化 ΔOI Δ Exposure*: -2k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 16 ｜ +19 ｜ $0.80 ｜ 名义 $1.5k* ｜ -7.2%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：16（-7.2%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 19（结算参考） ｜ Put Wall 16（-7.2%）（OI 66）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 80.0%｜历史 Rank 49%（近端代理）｜净 delta 敞口 负 2,467 股（方向不可观测）——方向不可观测，观察点，非方向信号
