...
🟡 **近现价集中开仓**: 09-04 535C ΔOI +966（距现价 +5.0%）
...
SOXX  昨收 508.62 → 今晨 509.34（+0.1%） | 较昨收变动（含盘初走势） ｜ 今日高 514.33 ｜ 低 507.03
...
Gamma Regime: NEGATIVE（模型分类） | GEX(存量) -16,628,924 | GEX Change N/A | Flip: Primary Flip: 524.70（PRIMARY，全链重定价 + 覆盖达标）
...
Put Wall 500（弱结构｜现价高于该位 1.9%）
最近结构参考: Put Wall 500（现价高于该位 1.9%）
🧭 结构解读（全部依赖上方假设）
...
C 535 ｜ +966 ｜ $1.92 ｜ 名义 $185.5k* ｜ +5.0%
P 497 ｜ +906 ｜ $5.08 ｜ 名义 $460.2k* ｜ -2.3%
P 465 ｜ +864 ｜ $0.70 ｜ 名义 $60.5k* ｜ -8.7%
结构参考：535（+5.0%）上方 / 497（-2.3%）下方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 595 ｜ +1,400 ｜ $1.35 ｜ 名义 $189.0k* ｜ +16.8%
C 600 ｜ +987 ｜ $1.20 ｜ 名义 $118.4k* ｜ +17.8%
P 500 ｜ +66 ｜ $16.10 ｜ 名义 $106.3k* ｜ -1.8%
结构参考：595（+16.8%）上方 / 500（-1.8%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
