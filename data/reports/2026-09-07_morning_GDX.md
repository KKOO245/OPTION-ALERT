...
🟡 **近现价集中开仓**: 09-11 101C ΔOI +15,747（距现价 +1.8%）
...
GDX  昨收 99.26 → 今开 98.75（-0.5%） | 较昨收变动（含盘初走势） ｜ 今日高 100.10 ｜ 低 98.01
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 42,890,184 | GEX Change vs 上次快照 36,105,263 | Flip: Primary Flip: 96.88（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 正 Gamma（4289万，无历史分位）｜正 Gamma 增强（+3611万）｜现价位于 Flip 上方 2.46%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
09-11  C +53.5k / P +16.8k ｜ Activity HIGH ｜ 4D
09-18  C +1.1k / P +4.7k ｜ Activity HIGH ｜ 11D
09-25  C +19 / P -32 ｜ Activity LOW ｜ 18D
10-02  C +0.1k / P -29 ｜ Activity MEDIUM △ ｜ 25D

📆 09-11 Forward Structure
存量OI:      C 102.6k / P 52.8k
今日变化ΔOI: C +53.5k / P +16.8k
平值价格ATM:  C 2.39 / P 2.10
隐含波动率 ATM IV:  40.8%
净 delta 敞口变化 ΔOI Δ Exposure*: 1.2M shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 101 ｜ +15,747 ｜ $1.56 ｜ 名义 $2.46M* ｜ +1.8%
C 104 ｜ +13,717 ｜ $0.65 ｜ 名义 $891.6k* ｜ +4.8%
C 102 ｜ +8,501 ｜ $1.16 ｜ 名义 $986.1k* ｜ +2.8%
结构参考：101（+1.8%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 98（结算参考） ｜ Call Wall 104（+4.8%，弱）（OI 17.1k） ｜ Put Wall 90（-9.3%，弱）（OI 9.8k）
量化解读： 存量 Call 重｜ATM IV 40.8%｜历史 Rank 62%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 1,217,811 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-18 Forward Structure
存量OI:      C 246.9k / P 416.6k
今日变化ΔOI: C +1.1k / P +4.7k
平值价格ATM:  C 3.70 / P 3.13
隐含波动率 ATM IV:  43.4%
净 delta 敞口变化 ΔOI Δ Exposure*: 100k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 95 ｜ +2,166 ｜ $6.11 ｜ 名义 $1.32M* ｜ -4.3%
C 103 ｜ -1,376 ｜ $1.83 ｜ 名义 $-251.8k* ｜ +3.8%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：95（-4.3%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 90（结算参考） ｜ Call Wall 100（+0.7%，弱）（OI 23.8k）
量化解读： 存量 Put 重｜ATM IV 43.4%｜历史 Rank 62%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 99,936 股（方向不可观测）——方向不可观测，观察点，非方向信号

09-25（Activity LOW）仓位参考: Max Pain 96（结算参考） ｜ Call Wall 105（+5.8%，弱）（OI 0.7k）

10-02（MEDIUM △）Top ΔOI: 100C +42 ｜ 97P +20
10-02（MEDIUM △）仓位参考: Max Pain 99（结算参考） ｜ Put Wall 97（-2.3%）（OI 15.1k）

数据质量: 行情 A ｜ 期权结构 A ｜ 流向 C ｜ 做市商机制 C —— Flow 相关层（Activity 连续性、做市商机制解读）置信度受限。
Setup: 今日无 Setup 触发（机械检查全部 Setup）

数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-07/GDX_morning.json