...
TSLA: 今晨 354.71 → 收盘 349.34（-1.5%） ｜ 今日高 363.24 ｜ 低 348.26
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞


## TSLA

Options: P/C量 0.79 | OI比 0.68 | ATM IV 43.8% | Skew -0.1pp | Term 0.92 | ExpMove ±2.6% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.79×（Call 成交高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.68×（Put OI 低于 Call OI）→ 存量 Call-dominant
   ⇒ 两者结构一致
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma: POSITIVE | GEX(存量) N/A | GEX Change N/A | Flip: ≈350.37 / ≈364.67 / ≈387.39
结构观察区: 350–365（局部 Gamma 切换，低置信；Top-3 近似，需全链重定价验证）
距 Put Wall 200: +74.7% | 距 Call Wall 400: -12.7%
🧭 结构解读（全部依赖上方假设）
• 支撑/压力参考：下方 200（Put Wall）；上方 400（Call Wall）。
• Gamma 区域：切换参考 350（Top-3 近似，需全链重定价验证）。
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-24/TSLA_evening.json