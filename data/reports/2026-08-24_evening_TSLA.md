...
TSLA: 今晨 354.71 → 收盘 354.21（-0.1%）
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞


## TSLA

Options: P/C量 0.78 | OI比 0.89 | ATM IV 47.1% | Skew -0.6pp | Term 0.85 | ExpMove ±0.7% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.78×（Call 成交高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.89×（Put OI 低于 Call OI）→ 存量 Call-dominant
   ⇒ 两者结构一致
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma: POSITIVE | GEX(存量) N/A | GEX Change N/A | Flip: ≈349.29 / ≈363.32 / ≈381.14
结构观察区: 349–363（局部 Gamma 切换，低置信；Top-3 近似，需全链重定价验证）
距 Put Wall 300: +18.1% | 距 Call Wall 400: -11.4%
🧭 结构解读（全部依赖上方假设）
