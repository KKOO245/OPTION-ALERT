...
NBIS: 今晨 211.22 → 收盘 210.86（-0.2%）
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞


## NBIS

Options: P/C量 0.73 | OI比 0.97 | ATM IV 100.3% | Skew -0.8pp | Term 0.91 | ExpMove ±8.5% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.73×（Call 成交高于 Put）→ 方向 Unknown
...
距 Put Wall 200: +5.4% | 距 Call Wall 250: -15.7%
🧭 结构解读（全部依赖上方假设）
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-24/NBIS_evening.json