...
CCO: 今晨 2.38 → 收盘 2.40（+1.1%） ｜ 今日高 2.40 ｜ 低 2.37
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞

Options: P/C量 N/A | OI比 0.28 | ATM IV 63.0% | Skew N/A | Term N/A | ExpMove ±12.5%（近端） | Rank — (历史不足)
   ⇒ Put/Call Volume: 数据不足 → 方向 Unknown
   ⇒ Put/Call OI: 0.28×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ExpMove 期限化（expmove_v1）: 09-18（23D）±15.8%
...
距 Put Wall 2: +20.0% | 距 Call Wall 3: -20.0%
最近结构参考: Flip 2（距现价 +7.1%）
🧭 结构解读（全部依赖上方假设）
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-26/CCO_evening.json