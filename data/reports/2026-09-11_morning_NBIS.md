...
平值价格ATM:  C 10.70 / P 9.35
隐含波动率 ATM IV:  76.7%
净 delta 敞口变化 ΔOI Δ Exposure*: 533k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 235 ｜ +3,446 ｜ $8.60 ｜ 名义 $2.96M* ｜ +1.8%
C 227 ｜ +2,728 ｜ $12.45 ｜ 名义 $3.40M* ｜ -1.5%
C 197 ｜ +1,810 ｜ $33.50 ｜ 名义 $6.06M* ｜ -14.5%
结构参考：235（+1.8%） / 227（-1.5%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 220（结算参考）
量化解读： 存量 Put 重｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 76.7%｜历史 Rank 54%（近端代理）｜净 delta 敞口 正 532,573 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-25 Forward Structure
存量OI:      C 13.0k / P 16.1k
今日变化ΔOI: C +0.3k / P +0.5k
平值价格ATM:  C 14.85 / P 13.21
隐含波动率 ATM IV:  77.1%
净 delta 敞口变化 ΔOI Δ Exposure*: 411 shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 200 ｜ +145 ｜ $3.52 ｜ 名义 $51.0k* ｜ -13.4%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：200（-13.4%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 220（结算参考）
量化解读： 存量 Put 重｜ATM IV 77.1%｜历史 Rank 54%（近端代理）｜净 delta 敞口 正 411 股（方向不可观测）——方向不可观测，观察点，非方向信号
...
平值价格ATM:  C 19.67 / P 20.92
隐含波动率 ATM IV:  80.2%
净 delta 敞口变化 ΔOI Δ Exposure*: 4k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 235 ｜ +206 ｜ $19.17 ｜ 名义 $394.9k* ｜ +1.8%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：235（+1.8%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 230（结算参考）
量化解读： 存量 Put 重｜ATM IV 80.2%｜历史 Rank 54%（近端代理）｜净 delta 敞口 正 3,738 股（方向不可观测）——方向不可观测，观察点，非方向信号
