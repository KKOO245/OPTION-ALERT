...
🔍 重点速览
🟡 **近现价集中开仓**: 09-11 192C ΔOI +3,399（距现价 +4.3%）
...
C 195 ｜ +4,371 ｜ $2.73 ｜ 名义 $1.19M* ｜ +5.6%
C 192 ｜ +3,399 ｜ $3.35 ｜ 名义 $1.14M* ｜ +4.3%
C 187 ｜ +1,390 ｜ $4.75 ｜ 名义 $660.2k* ｜ +1.5%
结构参考：195（+5.6%）附近形成 OI 变化集中（结构观察，非价格预测）
...
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 170（结算参考） ｜ Call Wall 170（-7.9%）（OI 16.1k）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 185 ｜ +540 ｜ $11.30 ｜ 名义 $610.2k* ｜ +0.2%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：185（+0.2%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 170（结算参考） ｜ Call Wall 185（+0.2%，弱）（OI 0.9k）
...
P 170 ｜ +179 ｜ $6.50 ｜ 名义 $116.3k* ｜ -7.9%
C 200 ｜ +117 ｜ $7.80 ｜ 名义 $91.3k* ｜ +8.3%
结构参考：187（+1.5%） / 170（-7.9%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 188（结算参考） ｜ Put Wall 172.5（-6.6%，弱）（OI 1.1k）
