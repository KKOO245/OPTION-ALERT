...
🟡 **单日价格波动**: +2.7%（vs 前收盘）
   ⇒ 价格变动超阈值；纯事实，不解释方向
🟡 **近现价集中开仓**: 09-04 190C ΔOI +3,604（距现价 +3.6%）
...
COIN  昨收 178.64 → 今晨 183.48（+2.7%） | 较昨收变动（含盘初走势） ｜ 今日高 185.28 ｜ 低 176.73

Options: P/C量 0.32 | OI比 0.44 | ATM IV 66.2% | Skew -5.3pp | Term 0.95 | ExpMove ±5.7%（近端） | Rank 23%
   ⇒ Put/Call Volume: 0.32×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.44×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ⇒ 两者结构一致
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量Call-dominant
   ExpMove 期限化（expmove_v1）: 09-04（4D）±5.7% ｜ 09-11（11D）±8.3% ｜ 09-18（18D）±11.2% ｜ 09-25（25D）±14.0%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 24,624,395 | GEX Change vs 上次快照 9,645,201 | Flip: Primary Flip: 162.07（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 100%（带内） ｜ IV 有效性: VALID 525 / LOW 159 / INVALID 360
结构观察区: Primary Flip 162.07（全链重定价，覆盖 100%）
Call Wall 200（弱结构｜现价低于该位 8.3%）
最近结构参考: Call Wall 200（现价低于该位 8.3%）
🧭 结构解读（全部依赖上方假设）
...
ATM:      C 5.74 / P 4.65
ATM IV:   66.2%
ΔOI Δ Exposure*: 466k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 200 ｜ +7,913 ｜ $1.07 ｜ 名义 $846.7k* ｜ +9.0%
C 190 ｜ +3,604 ｜ $2.89 ｜ 名义 $1.04M* ｜ +3.6%
C 192 ｜ +2,543 ｜ $2.25 ｜ 名义 $572.2k* ｜ +4.9%
结构参考：200（+9.0%）上方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 115 ｜ +1,467 ｜ $0.04 ｜ 名义 $5.9k* ｜ -37.3%
C 205 ｜ -335 ｜ $2.00 ｜ 名义 $-67.0k* ｜ +11.7%
P 165 ｜ +196 ｜ $1.48 ｜ 名义 $29.0k* ｜ -10.1%
结构参考：115（-37.3%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 100 ｜ +3,975 ｜ $0.07 ｜ 名义 $27.8k* ｜ -45.5%
P 120 ｜ +467 ｜ $0.12 ｜ 名义 $5.6k* ｜ -34.6%
C 205 ｜ +342 ｜ $3.68 ｜ 名义 $125.9k* ｜ +11.7%
结构参考：205（+11.7%）上方 / 100（-45.5%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）

   Top ΔOI: 110P +102 ｜ 210C +68

📅 事件差分（观察，非因果）: 09-04（4D）ATM IV 66.2% vs 09-11 59.5%（差 +6.8pp）——覆盖 职位空缺(JOLTS) Job Openings、ISM 制造业 PMI 等
