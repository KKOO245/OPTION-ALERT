...
🟡 **单日价格波动**: +3.0%（vs 前收盘）
   ⇒ 价格变动超阈值；纯事实，不解释方向
🟡 **近现价集中开仓**: 09-04 190C ΔOI +3,604（距现价 +3.2%）
...
COIN  昨收 178.64 → 今晨 184.03（+3.0%） | 较昨收变动（含盘初走势） ｜ 今日高 185.66 ｜ 低 176.73

Options: P/C量 0.30 | OI比 0.44 | ATM IV 67.6% | Skew -6.4pp | Term 0.93 | ExpMove ±5.7%（近端） | Rank 26%
   ⇒ Put/Call Volume: 0.30×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.44×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ⇒ 两者结构一致
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量Call-dominant
   ExpMove 期限化（expmove_v1）: 09-04（4D）±5.7% ｜ 09-11（11D）±8.6% ｜ 09-18（18D）±11.5% ｜ 09-25（25D）±13.3%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 25,091,382 | GEX Change vs 上次快照 10,112,188 | Flip: Primary Flip: 161.50（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 100%（带内） ｜ IV 有效性: VALID 537 / LOW 160 / INVALID 347
结构观察区: Primary Flip 161.50（全链重定价，覆盖 100%）
Call Wall 200（弱结构｜现价低于该位 8.0%）
最近结构参考: Call Wall 200（现价低于该位 8.0%）
🧭 结构解读（全部依赖上方假设）
• Gamma 区域：切换参考 161（全链重定价，覆盖 100%）。
...
ATM:      C 4.97 / P 5.59
ATM IV:   67.6%
ΔOI Δ Exposure*: 502k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 200 ｜ +7,913 ｜ $1.23 ｜ 名义 $973.3k* ｜ +8.7%
C 190 ｜ +3,604 ｜ $3.15 ｜ 名义 $1.14M* ｜ +3.2%
C 192 ｜ +2,543 ｜ $2.61 ｜ 名义 $663.7k* ｜ +4.6%
结构参考：200（+8.7%）上方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 115 ｜ +1,467 ｜ $0.04 ｜ 名义 $5.9k* ｜ -37.5%
C 205 ｜ -335 ｜ $2.05 ｜ 名义 $-68.7k* ｜ +11.4%
P 165 ｜ +196 ｜ $1.48 ｜ 名义 $29.0k* ｜ -10.3%
结构参考：115（-37.5%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 100 ｜ +3,975 ｜ $0.07 ｜ 名义 $27.8k* ｜ -45.7%
P 120 ｜ +467 ｜ $0.12 ｜ 名义 $5.6k* ｜ -34.8%
C 205 ｜ +342 ｜ $4.00 ｜ 名义 $136.8k* ｜ +11.4%
结构参考：205（+11.4%）上方 / 100（-45.7%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）

   Top ΔOI: 110P +102 ｜ 210C +68

📅 事件差分（观察，非因果）: 09-04（4D）ATM IV 67.6% vs 09-11 60.1%（差 +7.5pp）——覆盖 职位空缺(JOLTS) Job Openings、ISM 制造业 PMI 等
