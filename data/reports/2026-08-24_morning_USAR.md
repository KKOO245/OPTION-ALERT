...
Options: P/C量 0.89 | OI比 0.44 | ATM IV 99.7% | Skew -4.7pp | Term 0.88 | ExpMove ±8.6% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.89×（Call 成交高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.44×（Put OI 低于 Call OI）→ 存量 Call-dominant
   ⇒ 两者结构一致
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma: POSITIVE | GEX(存量) N/A | GEX Change N/A | Flip: ≈6.63 / ≈8.29 / ≈22.16
结构观察区: 7–8（局部 Gamma 切换，低置信；Top-3 近似，需全链重定价验证）
距 Put Wall 15: +20.7% | 距 Call Wall 20: -9.5%
🧭 结构解读（全部依赖上方假设）
