...
SNDK: 今开 1,895.00 → 收盘 1,816.57（-4.1%） ｜ 今日高 1902.22 ｜ 低 1803.67 ｜ 昨收 1,887.04 → 收盘 1,816.57（-3.7%）
Target 状态: 无待验证 Target（今日无 Setup 触发）

Options: P/C成交量 0.52 | OI比 1.24 | ATM IV 80.3% | Skew -6.5pp | Term 0.95 | ExpMove ±7.2%（近端） | Rank 36%
量化视角： IV 中性（Rank 36%）｜期限结构正常（Term 0.95）｜Put 保护异常便宜（Skew -6.5pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
...
存量OI: C 39.4k / P 48.9k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $107.00 / P $24.60 ｜ ATM IV 80.3%，净 delta 敞口 0 shares
仓位参考: Max Pain 1,700 ｜ Call Wall 1800（-0.9%，弱）（OI 2.6k） ｜ Put Wall 1700（-6.4%，弱）（OI 2.0k）
量化解读： 存量 Put 重｜ATM IV 80.3%｜历史 Rank 36%（近端代理）｜IV/RV 1.13×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

10-02（Activity LOW）仓位参考: Max Pain 1,600 ｜ Call Wall 1800（-0.9%，弱）（OI 0.9k） ｜ Put Wall 1680（-7.5%，弱）（OI 0.3k）

10-09（Activity LOW）仓位参考: Max Pain 1,500 ｜ Put Wall 1690（-7.0%，弱）（OI 0.1k）

10-16（Activity LOW）仓位参考: Max Pain 1,610 ｜ Call Wall 1800（-0.9%，弱）（OI 1.2k） ｜ Put Wall 1700（-6.4%，弱）（OI 1.2k）

数据质量: 行情 A ｜ 期权结构 A ｜ 流向 C ｜ 做市商机制 C —— Flow 相关层（Activity 连续性、做市商机制解读）置信度受限。
Setup: 今日无 Setup 触发（机械检查全部 Setup）

数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-23/SNDK_evening.json