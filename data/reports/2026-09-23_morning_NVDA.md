...
NVDA  昨收 228.87 → 今开 228.08（-0.3%） | 较昨收变动（含盘初走势） ｜ 今日高 228.95 ｜ 低 225.12

Options: P/C成交量 0.34 | OI比 0.74 | ATM IV 31.2% | Skew 0.3pp | Term 1.00 | ExpMove ±2.4%（近端） | Rank 9%
量化视角： IV 历史低位（Rank 9%，期权偏便宜）｜期限结构正常（Term 1.00）｜保护溢价薄（Skew 0.3pp）｜存量 Call 偏重（OI比 0.74）——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-25（2D）±2.4% ｜ 09-28（5D）±2.8% ｜ 09-30（7D）±3.5% ｜ 10-02（9D）±4.2%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 782,358,499 | GEX Change vs 上次快照 -10,532,829 | Flip: Primary Flip: 214.06（PRIMARY，全链重定价 + 覆盖达标）
...
Call Wall 230（现价低于该位 0.6%）
最近结构参考: Call Wall 230（现价低于该位 0.6%）
量化视角： 正 Gamma（7.82亿，无历史分位）｜正 Gamma 减弱（1053万）｜现价位于 Flip 上方 6.77%｜⚠️ 重点观察：正 Gamma 由正转负（结构切换）——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
- 无中高变动事件（全部低等级）
🎯 今日到期（0DTE）
存量OI: C 130.9k / P 96.6k，今日成交量: C 753.7k / P 257.7k，平值价格ATM: C $2.28 / P $0.92 ｜ ATM IV 31.2%，预期波动 ±1.4%，Max Pain 222
...
量化解读： 存量 Call 重｜ATM IV 31.5%｜历史 Rank 9%（近端代理）｜IV/RV 1.03×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-23/NVDA_morning.json