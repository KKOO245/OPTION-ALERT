...
Options: P/C量 1.12 | OI比 0.83 | ATM IV 96.2% | Skew 2.6pp | Term 0.92 | ExpMove ±8.4% | Rank — (历史不足)
...
距 Put Wall 16: +13.6% | 距 Call Wall 25: -27.3%
🧭 结构解读（全部依赖上方假设）
• 支撑/压力参考：下方 16（Put Wall）；上方 25（Call Wall）。
• Gamma 区域：切换参考 24（Top-3 近似，需全链重定价验证）。
