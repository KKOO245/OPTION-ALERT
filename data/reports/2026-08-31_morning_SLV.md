...
🟡 **近现价集中开仓**: 09-09 61C ΔOI +710（距现价 +2.6%）
...
SLV  昨收 60.02 → 今晨 59.95（-0.1%） | 较昨收变动（含盘初走势） ｜ 今日高 60.42 ｜ 低 59.66

Options: P/C量 0.60 | OI比 0.25 | ATM IV 34.2% | Skew -0.8pp | Term 1.20 | ExpMove ±2.4%（近端） | Rank 56%
   ⇒ Put/Call Volume: 0.60×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.25×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ⇒ 两者结构一致
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量Call-dominant
   ExpMove 期限化（expmove_v1）: 09-02（2D）±2.4% ｜ 09-04（4D）±3.6% ｜ 09-09（9D）±4.6% ｜ 09-11（11D）±5.4%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 107,773,993 | GEX Change N/A | Flip: Primary Flip: 55.03（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 96%（带内） ｜ IV 有效性: VALID 1033 / LOW 271 / INVALID 542
结构观察区: Primary Flip 55.03（全链重定价，覆盖 96%）
...
P 64 ｜ +1,786 ｜ $4.13 ｜ 名义 $737.6k* ｜ +6.8%
C 66 ｜ +975 ｜ $0.02 ｜ 名义 $1.9k* ｜ +10.9%
C 66 ｜ +858 ｜ $0.02 ｜ 名义 $1.7k* ｜ +10.1%
结构参考：64（+6.8%）上方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 64 ｜ +2,014 ｜ $0.12 ｜ 名义 $24.2k* ｜ +7.6%
C 68 ｜ +1,549 ｜ $0.05 ｜ 名义 $7.7k* ｜ +13.4%
C 65 ｜ +1,321 ｜ $0.10 ｜ 名义 $13.2k* ｜ +8.4%
结构参考：64（+7.6%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 79 ｜ +1,000 ｜ $0.06 ｜ 名义 $6.0k* ｜ +31.8%
C 61 ｜ +710 ｜ $0.79 ｜ 名义 $56.1k* ｜ +2.6%
C 71 ｜ +500 ｜ $0.29 ｜ 名义 $14.5k* ｜ +19.3%
结构参考：79（+31.8%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 64 ｜ +2,674 ｜ $0.49 ｜ 名义 $131.0k* ｜ +6.8%
C 80 ｜ -1,241 ｜ $0.03 ｜ 名义 $-3.7k* ｜ +33.4%
C 63 ｜ +943 ｜ $0.70 ｜ 名义 $66.0k* ｜ +5.1%
结构参考：64（+6.8%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
