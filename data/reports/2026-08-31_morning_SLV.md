...
🟡 **近现价集中开仓**: 09-09 61C ΔOI +710（距现价 +2.7%）
...
SLV  昨收 60.02 → 今晨 59.89（-0.2%） | 较昨收变动（含盘初走势） ｜ 今日高 60.42 ｜ 低 59.66

Options: P/C量 0.60 | OI比 0.25 | ATM IV 35.2% | Skew -1.6pp | Term 1.16 | ExpMove ±2.4%（近端） | Rank 58%
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 106,860,198 | GEX Change N/A | Flip: Primary Flip: 54.99（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 96%（带内） ｜ IV 有效性: VALID 1030 / LOW 265 / INVALID 551
结构观察区: Primary Flip 54.99（全链重定价，覆盖 96%）
最近结构参考: Flip 55（现价高于该位 8.9%）
🧭 结构解读（全部依赖上方假设）
...
ATM:      C 0.70 / P 0.75
ATM IV:   39.6%
ΔOI Δ Exposure*: -257k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 64 ｜ +1,786 ｜ $4.08 ｜ 名义 $728.7k* ｜ +6.9%
C 66 ｜ +975 ｜ $0.02 ｜ 名义 $1.9k* ｜ +11.0%
C 66 ｜ +858 ｜ $0.02 ｜ 名义 $1.7k* ｜ +10.2%
结构参考：64（+6.9%）上方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 64 ｜ +2,014 ｜ $0.12 ｜ 名义 $24.2k* ｜ +7.7%
C 68 ｜ +1,549 ｜ $0.05 ｜ 名义 $7.7k* ｜ +13.5%
C 65 ｜ +1,321 ｜ $0.10 ｜ 名义 $13.2k* ｜ +8.5%
结构参考：64（+7.7%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 79 ｜ +1,000 ｜ $0.06 ｜ 名义 $6.0k* ｜ +31.9%
C 61 ｜ +710 ｜ $0.85 ｜ 名义 $60.4k* ｜ +2.7%
C 71 ｜ +500 ｜ $0.29 ｜ 名义 $14.5k* ｜ +19.4%
结构参考：79（+31.9%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 64 ｜ +2,674 ｜ $0.49 ｜ 名义 $131.0k* ｜ +6.9%
C 80 ｜ -1,241 ｜ $0.03 ｜ 名义 $-3.7k* ｜ +33.6%
C 63 ｜ +943 ｜ $0.67 ｜ 名义 $63.2k* ｜ +5.2%
结构参考：64（+6.9%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
