...
Options: P/C成交量 0.55 | OI比 0.80 | ATM IV 78.7% | Skew -10.4pp | Term 0.89 | ExpMove ±5.8%（近端） | Rank 46%
量化视角： IV 中性（Rank 46%）｜期限结构倒挂（Term 0.89，近月 IV 高于远月）｜Put 保护异常便宜（Skew -10.4pp，Put IV < Call IV）｜存量 Call 偏重（OI比 0.80）——观察点，非方向信号
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 65,360,317 | GEX Change vs 上次快照 5,048,158 | Flip: NO_CROSS
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 100%（带内） ｜ IV 有效性: VALID 900 / LOW 59 / INVALID 113
结构观察区: NO_CROSS
量化视角： 正 Gamma（6536万，无历史分位）｜正 Gamma 增强（+505万）——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
量化解读： 存量 Call 重｜ATM IV 78.7%｜历史 Rank 46%（近端代理）｜IV/RV 0.76×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

10-02（Activity LOW）仓位参考: Max Pain 140 ｜ Call Wall 180（+7.6%，弱）（OI 5.3k）

10-09（Activity LOW）仓位参考: Max Pain 140 ｜ Call Wall 160（-4.4%，弱）（OI 4.9k）

10-16（Activity LOW）仓位参考: Max Pain 115 ｜ Call Wall 180（+7.6%，弱）（OI 10.5k） ｜ Put Wall 160（-4.4%，弱）（OI 2.6k）
