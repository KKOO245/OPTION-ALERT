...
SNDK  昨收 1,816.57 → 今开 1,785.47（-1.7%） | 较昨收变动（含盘初走势） ｜ 今日高 1802.99 ｜ 低 1745.86
...
量化视角： IV 中性（Rank 36%）｜期限结构正常（Term 0.94）｜Put 保护异常便宜（Skew -6.5pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-25（1D）±5.9% ｜ 10-02（8D）±10.8% ｜ 10-09（15D）±13.5% ｜ 10-16（22D）±15.7%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 14,448,665 | GEX Change vs 上次快照 3,793,349 | Flip: Primary Flip: 1703.15（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 正 Gamma（1445万，无历史分位）｜正 Gamma 增强（+379万）｜现价位于 Flip 上方 11.48%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
量化解读： 存量 Put 重｜ATM IV 81.3%｜历史 Rank 36%（近端代理）｜IV/RV 1.11×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-24/SNDK_morning.json