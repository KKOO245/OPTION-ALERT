...
🔍 重点速览
🟡 **近现价集中开仓**: 09-25 155C ΔOI +788（距现价 +4.7%）
...
Options: P/C成交量 0.35 | OI比 1.27 | ATM IV 82.2% | Skew -3.5pp | Term 0.62 | ExpMove ±6.1%（近端） | Rank 100%
量化视角： IV 历史高位（Rank 100%，期权偏贵）｜期限结构倒挂（Term 0.62，近月 IV 高于远月）｜Put 保护异常便宜（Skew -3.5pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
   ⇒ Put/Call Volume: 0.35×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 1.27×（存量 Put 仓位高于 Call）→ 存量 Put-dominant
   ⇒ 两者结构不一致
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量Put-dominant
   ExpMove 期限化（expmove_v1）: 09-18（7D）±6.1% ｜ 09-25（14D）±8.2% ｜ 10-02（21D）±9.9% ｜ 10-09（28D）±11.2%
   ⇒ IV–VIX Spread: +66.2pp*（*近月 ATM IV − VIX；期限未对齐，仅作相对波动率 Proxy，不直接代表期权定价贵/便宜）
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 38,974,907 | GEX Change vs 上次快照 6,608,793 | Flip: Primary Flip: 145.61（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 98%（带内） ｜ IV 有效性: VALID 549 / LOW 172 / INVALID 383
结构观察区: Primary Flip 145.61（全链重定价，覆盖 98%）
Call Wall 150（弱结构｜现价低于该位 1.3%）
最近结构参考: Call Wall 150（现价低于该位 1.3%）
量化视角： 正 Gamma（3897万，无历史分位）｜正 Gamma 增强（+661万）｜现价位于 Flip 上方 1.69%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
• 支撑/压力参考：下方 147（MaxPain，仅结算参考）；上方 150（Call Wall，弱结构）。
• Gamma 区域：切换参考 146（全链重定价，覆盖 98%）。
...
10-09  C +1.2k / P +0.8k ｜ Activity MEDIUM △ ｜ 28D

📆 09-18 Forward Structure
存量OI:      C 595.0k / P 490.9k
今日变化ΔOI: C +4.9k / P +12.7k
平值价格ATM:  C 3.84 / P 5.15
隐含波动率 ATM IV:  53.3%
净 delta 敞口变化 ΔOI Δ Exposure*: -51k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 165 ｜ -2,184 ｜ $0.57 ｜ 名义 $-124.5k* ｜ +11.4%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 145（结算参考） ｜ Call Wall 155（+4.7%，弱）（OI 54.0k） ｜ Put Wall 150（+1.3%）（OI 46.2k）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 53.3%｜历史 Rank 100%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 51,319 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-25 Forward Structure
存量OI:      C 51.5k / P 67.1k
今日变化ΔOI: C +3.6k / P +1.4k
平值价格ATM:  C 6.35 / P 5.75
隐含波动率 ATM IV:  51.4%
净 delta 敞口变化 ΔOI Δ Exposure*: 44k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 155 ｜ +788 ｜ $3.55 ｜ 名义 $279.7k* ｜ +4.7%
C 170 ｜ -761 ｜ $0.86 ｜ 名义 $-65.4k* ｜ +14.8%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：155（+4.7%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 144（结算参考）
量化解读： 存量 Put 重｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 51.4%｜历史 Rank 100%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 43,804 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 10-02 Forward Structure
存量OI:      C 24.8k / P 36.6k
今日变化ΔOI: C +1.3k / P +1.3k
平值价格ATM:  C 7.65 / P 7.05
隐含波动率 ATM IV:  51.0%
净 delta 敞口变化 ΔOI Δ Exposure*: -15k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 170 ｜ +520 ｜ $1.47 ｜ 名义 $76.4k* ｜ +14.8%
P 145 ｜ +466 ｜ $5.85 ｜ 名义 $272.6k* ｜ -2.1%
P 140 ｜ +214 ｜ $3.69 ｜ 名义 $79.0k* ｜ -5.5%
结构参考：170（+14.8%） / 145（-2.1%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 145（结算参考）
量化解读： 存量 Put 重｜ATM IV 51.0%｜历史 Rank 100%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 15,245 股（方向不可观测）——方向不可观测，观察点，非方向信号

10-09（MEDIUM △）Top ΔOI: 160C +335 ｜ 150P +205
10-09（MEDIUM △）仓位参考: Max Pain 146（结算参考） ｜ Put Wall 135（-8.8%）（OI 2.8k）
