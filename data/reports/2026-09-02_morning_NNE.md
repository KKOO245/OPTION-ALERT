...
NNE  昨收 17.47 → 今开 17.43（-0.2%） | 较昨收变动（含盘初走势） ｜ 今日高 17.70 ｜ 低 17.20
...
量化视角： IV 历史低位（Rank 12%，期权偏便宜）｜期限结构倒挂（Term 0.88，近月 IV 高于远月）｜保护溢价显著（Skew 6.2pp，Put 明显贵于 Call）｜存量 Call 偏重（OI比 0.69）——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-04（2D）±5.7% ｜ 09-11（9D）±8.8% ｜ 09-18（16D）±13.1% ｜ 09-25（23D）±13.9%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 482,033 | GEX Change vs 上次快照 193,080 | Flip: Primary Flip: 17.11（PRIMARY，全链重定价 + 覆盖达标）
...
Put Wall 16（弱结构｜现价高于该位 9.4%）
最近结构参考: Flip 17（现价高于该位 2.3%）
量化视角： 正 Gamma（48万，无历史分位）｜正 Gamma 增强（+19万）｜现价位于 Flip 上方 2.32%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
P 17 ｜ +158 ｜ $0.25 ｜ 名义 $4.0k* ｜ -2.9%
C 18 ｜ +59 ｜ $0.20 ｜ 名义 $1.2k* ｜ +5.7%
C 17 ｜ +51 ｜ $0.55 ｜ 名义 $2.8k* ｜ -0.0%
结构参考：18（+5.7%） / 17（-2.9%）形成 OI 变化集中区（结构观察，非价格预测）
