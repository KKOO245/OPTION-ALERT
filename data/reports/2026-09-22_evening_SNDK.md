...
Options: P/C成交量 0.52 | OI比 1.24 | ATM IV 80.5% | Skew -6.5pp | Term 0.95 | ExpMove ±5.8%（近端） | Rank 35%
量化视角： IV 中性（Rank 35%）｜期限结构正常（Term 0.95）｜Put 保护异常便宜（Skew -6.5pp，Put IV < Call IV）｜当日成交与存量接近均衡——观察点，非方向信号
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 12,864,115 | GEX Change vs 上次快照 1,848,183 | Flip: Primary Flip: 1698.92（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 正 Gamma（1286万，无历史分位）｜正 Gamma 增强（+185万）｜现价位于 Flip 上方 11.07%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
存量OI: C 39.4k / P 48.9k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $56.00 / P $53.21 ｜ ATM IV 80.5%，净 delta 敞口 0 shares
仓位参考: Max Pain 1,700 ｜ Call Wall 2000（+6.0%，弱）（OI 3.7k） ｜ Put Wall 1700（-9.9%，弱）（OI 2.0k）
量化解读： 存量 Put 重｜ATM IV 80.5%｜历史 Rank 35%（近端代理）｜IV/RV 1.18×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

10-02（Activity LOW）仓位参考: Max Pain 1,600 ｜ Call Wall 2000（+6.0%，弱）（OI 1.0k） ｜ Put Wall 1700（-9.9%，弱）（OI 0.2k）

10-09（Activity LOW）仓位参考: Max Pain 1,500 ｜ Put Wall 1700（-9.9%，弱）（OI 99）

10-16（Activity LOW）仓位参考: Max Pain 1,610 ｜ Call Wall 2000（+6.0%，弱）（OI 2.1k） ｜ Put Wall 1700（-9.9%，弱）（OI 1.2k）
