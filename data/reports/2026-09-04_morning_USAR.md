...
🔍 重点速览
🟡 **近现价集中开仓**: 10-02 18C ΔOI +84（距现价 +2.3%）
...
USAR  昨收 17.69 → 今开 18.65（+5.4%） | 较昨收变动（含盘初走势） ｜ 今日高 19.30 ｜ 低 17.25

Options: P/C成交量 0.22 | OI比 0.31 | ATM IV 129.2% | Skew -5.6pp | Term 0.62 | ExpMove ±8.2%（近端） | Rank 62%
量化视角： IV 中性（Rank 62%）｜期限结构倒挂（Term 0.62，近月 IV 高于远月）｜Put 保护异常便宜（Skew -5.6pp，Put IV < Call IV）｜存量 Call 偏重（OI比 0.31）——观察点，非方向信号
   ⇒ Put/Call Volume: 0.22×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.31×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ⇒ 两者结构一致
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量Call-dominant
   ExpMove 期限化（expmove_v1）: 09-11（7D）±8.2% ｜ 09-18（14D）±17.7% ｜ 09-25（21D）±15.3% ｜ 10-02（28D）±17.3%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 7,614,678 | GEX Change vs 上次快照 2,830,945 | Flip: Primary Flip: 16.45（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 93%（带内） ｜ IV 有效性: VALID 227 / LOW 103 / INVALID 198
结构观察区: Primary Flip 16.45（全链重定价，覆盖 93%）
最近结构参考: Flip 16（现价高于该位 7.0%）
量化视角： 正 Gamma（761万，无历史分位）｜正 Gamma 增强（+283万）｜现价位于 Flip 上方 6.96%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
平值价格ATM:  C 0.90 / P 0.55
隐含波动率 ATM IV:  70.5%
净 delta 敞口变化 ΔOI Δ Exposure*: -18k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 17 ｜ +447 ｜ $0.39 ｜ 名义 $17.4k* ｜ -3.4%
C 19 ｜ +167 ｜ $0.30 ｜ 名义 $5.0k* ｜ +8.0%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：19（+8.0%） / 17（-3.4%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 70.5%｜历史 Rank 62%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 负 18,024 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-18 Forward Structure
存量OI:      C 113.8k / P 63.9k
今日变化ΔOI: C +1.2k / P -0.6k
平值价格ATM:  C 2.24 / P 0.87
隐含波动率 ATM IV:  75.7%
净 delta 敞口变化 ΔOI Δ Exposure*: 101k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 18 ｜ -305 ｜ $1.18 ｜ 名义 $-36.0k* ｜ +2.3%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 75.7%｜历史 Rank 62%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 100,977 股（方向不可观测）——方向不可观测，观察点，非方向信号
...
平值价格ATM:  C 1.66 / P 1.39
隐含波动率 ATM IV:  80.2%
净 delta 敞口变化 ΔOI Δ Exposure*: 74k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 23 ｜ +4,029 ｜ $0.31 ｜ 名义 $124.9k* ｜ +30.7%
C 18 ｜ +84 ｜ $2.10 ｜ 名义 $17.6k* ｜ +2.3%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：23（+30.7%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 80.2%｜历史 Rank 62%（近端代理）｜净 delta 敞口 正 74,026 股（方向不可观测）——方向不可观测，观察点，非方向信号
