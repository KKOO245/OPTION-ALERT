...
Options: P/C量 1.49 | OI比 1.40 | ATM IV 12.3% | Skew 3.1pp | Term 1.04 | ExpMove ±0.3% | Rank — (历史不足)
   ⇒ Put/Call Volume: 1.49×（Put 成交显著高于 Call）→ 方向 Unknown
...
距 Put Wall 535: +42.6% | 距 Call Wall 800: -4.7%
🧭 结构解读（全部依赖上方假设）
