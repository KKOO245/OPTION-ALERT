...
🟡 **近现价集中开仓**: 09-11 18P ΔOI +188（距现价 +1.0%）
...
NNE  昨收 17.97 → 今晨 18.32（+1.9%） | 较昨收变动（含盘初走势） ｜ 今日高 18.38 ｜ 低 17.80

Options: P/C量 0.29 | OI比 0.76 | ATM IV 90.7% | Skew 7.3pp | Term 0.96 | ExpMove ±9.0%（近端） | Rank 16%
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 886,202 | GEX Change vs 上次快照 148,891 | Flip: Primary Flip: 17.07（PRIMARY，全链重定价 + 覆盖达标）
...
P 16 ｜ +130 ｜ $0.15 ｜ 名义 $1.9k* ｜ -12.7%
P 17 ｜ +121 ｜ $0.38 ｜ 名义 $4.6k* ｜ -4.5%
P 17 ｜ +69 ｜ $0.27 ｜ 名义 $1.9k* ｜ -7.2%
结构参考：16（-12.7%）下方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 16 ｜ +189 ｜ $0.32 ｜ 名义 $6.0k* ｜ -12.7%
P 18 ｜ +188 ｜ $1.18 ｜ 名义 $22.2k* ｜ +1.0%
P 20 ｜ +84 ｜ $2.52 ｜ 名义 $21.2k* ｜ +11.9%
结构参考：18（+1.0%）上方 / 16（-12.7%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
