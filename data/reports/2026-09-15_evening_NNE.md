...
Target 等待验证: 3D_mdd >= 0.03（3D） — PENDING（评估日 ≈ 2026-09-18，窗口结束前不做对错判定）

Options: P/C成交量 0.53 | OI比 0.46 | ATM IV 89.9% | Skew -7.9pp | Term 0.89 | ExpMove ±7.0%（近端） | Rank 17%
量化视角： IV 历史低位（Rank 17%，期权偏便宜）｜期限结构倒挂（Term 0.89，近月 IV 高于远月）｜Put 保护异常便宜（Skew -7.9pp，Put IV < Call IV）｜存量 Call 偏重（OI比 0.46）——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-18（3D）±7.0% ｜ 09-25（10D）±11.1% ｜ 10-02（17D）±24.8% ｜ 10-09（24D）±16.0%
   ⇒ IV–VIX Spread: +72.7pp*（*近月 ATM IV − VIX；期限未对齐，仅作相对波动率 Proxy，不直接代表期权定价贵/便宜）
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 742,571 | GEX Change vs 上次快照 194,331 | Flip: Primary Flip: 14.38（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 93%（带内） ｜ IV 有效性: VALID 167 / LOW 96 / INVALID 187
结构观察区: Primary Flip 14.38（全链重定价，覆盖 93%）
Put Wall 15（弱结构｜现价高于该位 5.2%）
最近结构参考: Put Wall 15（现价高于该位 5.2%）
量化视角： 正 Gamma（74万，无历史分位）｜正 Gamma 增强（+19万）｜现价位于 Flip 上方 9.76%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
• 支撑/压力参考：下方 15（Put Wall，弱结构）；上方 18（MaxPain，仅结算参考）。
• Gamma 区域：切换参考 14（全链重定价，覆盖 93%）。
...
存量OI: C 8.7k / P 4.0k，今日变化ΔOI: C +0.8k / P +0.2k，平值价格ATM: C $0.40 / P $0.70 ｜ ATM IV 89.9%，净 delta 敞口 14k shares
Top ΔOI: C 17 +284
仓位参考: Max Pain 18 ｜ Call Wall 17（+7.7%，弱）（OI 0.4k） ｜ Put Wall 16（+1.4%，弱）（OI 0.8k）
量化解读： 存量 Call 重｜ATM IV 89.9%｜历史 Rank 17%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 14,103 股

09-25（MEDIUM △）Top ΔOI: 15P +98 ｜ 16P +78
09-25（MEDIUM △）仓位参考: Max Pain 18 ｜ Put Wall 15（-4.9%，弱）（OI 0.3k）

10-02（MEDIUM △）Top ΔOI: 15P +7
10-02（MEDIUM △）仓位参考: Max Pain 19 ｜ Put Wall 15（-4.9%）（OI 0.3k）

10-09（MEDIUM △）Top ΔOI: 16P +35
10-09（MEDIUM △）仓位参考: Max Pain 19 ｜ Put Wall 16（+1.4%）（OI 0.1k）

📅 事件差分（观察，非因果）: 09-18（3D）ATM IV 89.9% vs 09-25 83.0%（差 +6.9pp）——覆盖 零售销售 MoM、美联储利率决议 Decision、美联储议息会议 Economic Projections、Fed Press Conference、新屋开工、建筑许可 Prel
