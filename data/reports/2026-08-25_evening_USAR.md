...
USAR: 今晨 18.36 → 收盘 19.50（+6.2%） ｜ 今日高 19.47 ｜ 低 17.97
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞


## USAR

Options: P/C量 0.38 | OI比 0.61 | ATM IV 105.4% | Skew -3.3pp | Term 0.87 | ExpMove ±7.6% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.38×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.61×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ⇒ 两者结构一致
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量Call-dominant
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) N/A | GEX Change N/A | Flip: ≈6.80 / ≈19.52 / ≈21.50
结构观察区: 7–20（局部 Gamma 切换，低置信；Top-3 近似，需全链重定价验证）
距 Put Wall 15: +30.0% | 距 Call Wall 20: -2.5%
🧭 结构解读（全部依赖上方假设）
