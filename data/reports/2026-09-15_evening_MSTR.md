...
MSTR: 今开 131.65 → 收盘 129.60（-1.6%） ｜ 今日高 134.00 ｜ 低 125.44 ｜ 昨收 136.94 → 收盘 129.60（-5.4%）
Target 状态: 无待验证 Target（今日无 Setup 触发）

Options: P/C成交量 1.16 | OI比 0.60 | ATM IV 87.2% | Skew -3.4pp | Term 0.82 | ExpMove ±6.3%（近端） | Rank 61%
量化视角： IV 中性（Rank 61%）｜期限结构倒挂（Term 0.82，近月 IV 高于远月）｜Put 保护异常便宜（Skew -3.4pp，Put IV < Call IV）｜⚠️ 重点观察：存量 Call 重（OI比 0.60）+ 当日成交偏 Put（P/C量 1.16）——结构背离，买/卖方向不可观测——观察点，非方向信号
...
09-18 80.0P — Vol 142 | 最新价 $0.01 | OI 30489→34942 (ΔOI +4453张) | ΔOI/Volume N/A（量数据不完整） | Magnitude: MEDIUM | 完整度: HIGH
   ⇒ 放量且净增4453张（+14.6% vs前日OI），值得跟踪（方向未知）
09-18 200.0C — Vol 678 | 最新价 $0.01 | OI 22993→26257 (ΔOI +3264张) | ΔOI/Volume N/A（量数据不完整） | Magnitude: MEDIUM | 完整度: HIGH
   ⇒ 放量且净增3264张（+14.2% vs前日OI），值得跟踪（方向未知）
09-18 150.0C — Vol 15,629 | 最新价 $0.33 | OI 16313→18330 (ΔOI +2017张) | ΔOI/Volume 12.9% | Magnitude: HIGH | 完整度: HIGH
   ⇒ 大额净增2017张（+12.4% vs前日OI），连续性待观察（方向未知）
09-18 155.0C — Vol 3,896 | 最新价 $0.19 | OI 2974→4847 (ΔOI +1873张) | ΔOI/Volume 48.1% | Magnitude: HIGH | 完整度: HIGH
   ⇒ 大额净增1873张（+63.0% vs前日OI），连续性待观察（方向未知）
09-18 120.0P — Vol 28,189 | 最新价 $0.89 | OI 8782→10338 (ΔOI +1556张) | ΔOI/Volume 5.5% | Magnitude: HIGH | 完整度: HIGH
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-15/MSTR_evening.json