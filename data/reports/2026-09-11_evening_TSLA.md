...
存量OI: C 34.8k / P 29.2k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $3.69 / P $3.24 ｜ ATM IV 25.9%，净 delta 敞口 0 shares
仓位参考: Max Pain 365 ｜ Call Wall 400（+9.5%）（OI 7.0k）
量化解读： 存量 Call 重｜ATM IV 25.9%｜历史 Rank 10%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 0 股

09-16（Activity LOW）仓位参考: Max Pain 362 ｜ Call Wall 400（+9.5%，弱）（OI 2.3k） ｜ Put Wall 340（-7.0%，弱）（OI 1.3k）

09-18（Activity LOW）仓位参考: Max Pain 360

09-21（Activity LOW）仓位参考: Max Pain 365 ｜ Call Wall 380（+4.0%，弱）（OI 0.8k） ｜ Put Wall 345（-5.6%）（OI 0.6k）
