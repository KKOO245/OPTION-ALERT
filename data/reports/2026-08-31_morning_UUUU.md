...
🟡 **近现价集中开仓**: 09-04 15C ΔOI +369（距现价 +2.2%）
...
UUUU  昨收 14.67 → 今晨 14.68（+0.1%） | 较昨收变动（含盘初走势） ｜ 今日高 14.77 ｜ 低 14.35
...
Options: P/C量 0.18 | OI比 0.41 | ATM IV 74.6% | Skew -1.0pp | Term 0.96 | ExpMove ±6.7%（近端） | Rank 52%
   ...
   ExpMove 期限化（expmove_v1）: 09-04（4D）±6.7% ｜ 09-11（11D）±9.4% ｜ 09-18（18D）±12.8% ｜ 09-25（25D）±15.1%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 3,986,514 | GEX Change vs 上次快照 318,666 | Flip: Primary Flip: 12.58（PRIMARY，全链重定价 + 覆盖达标）
...
C 15 ｜ +369 ｜ $0.30 ｜ 名义 $11.1k* ｜ +2.2%
P 15 ｜ +166 ｜ $0.65 ｜ 名义 $10.8k* ｜ +2.2%
C 16 ｜ +143 ｜ $0.10 ｜ 名义 $1.4k* ｜ +9.0%
结构参考：15（+2.2%）上方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 16 ｜ +109 ｜ $0.29 ｜ 名义 $3.2k* ｜ +9.0%
P 15 ｜ +76 ｜ $0.93 ｜ 名义 $7.1k* ｜ +2.2%
C 14 ｜ +53 ｜ $1.10 ｜ 名义 $5.8k* ｜ -4.6%
结构参考：16（+9.0%）上方 / 14（-4.6%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
