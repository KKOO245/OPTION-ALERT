...
🔍 重点速览
🟡 **近现价集中开仓**: 10-02 16P ΔOI +31（距现价 -0.6%）
...
Options: P/C成交量 0.32 | OI比 0.39 | ATM IV 108.4% | Skew -2.4pp | Term 0.73 | ExpMove ±11.4%（近端） | Rank 48%
量化视角： IV 中性（Rank 48%）｜期限结构倒挂（Term 0.73，近月 IV 高于远月）｜Put 保护异常便宜（Skew -2.4pp，Put IV < Call IV）｜存量 Call 偏重（OI比 0.39）——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-25（7D）±11.4% ｜ 10-02（14D）±8.5% ｜ 10-09（21D）±18.4% ｜ 10-16（28D）±18.6%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 225,487 | GEX Change vs 上次快照 -1,135,106 | Flip: Primary Flip: 15.95（PRIMARY，全链重定价 + 覆盖达标）
...
Put Wall 15（现价高于该位 7.3%）
最近结构参考: Flip 16（现价高于该位 0.9%）
量化视角： 正 Gamma（23万，无历史分位）｜正 Gamma 减弱（114万）｜现价位于 Flip 上方 0.93%｜⚠️ 重点观察：正 Gamma 由正转负（结构切换）——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
🎯 今日到期（0DTE）
存量OI: C 9.7k / P 3.8k，今日成交量: C 1.4k / P 0.4k，平值价格ATM: C $1.07 / P $0.05 ｜ ATM IV 108.4%，预期波动 ±7.0%，Max Pain 18
...
仓位参考: Max Pain 18 ｜ Put Wall 15（-6.8%）（OI 0.5k）
量化解读： 存量 Call 重｜ATM IV 83.2%｜历史 Rank 48%（近端代理）｜IV/RV 1.23×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 3,107 股

10-02（MEDIUM △）Top ΔOI: 16P +31
10-02（MEDIUM △）仓位参考: Max Pain 18 ｜ Put Wall 15（-6.8%）（OI 0.2k）

10-09（MEDIUM △）仓位参考: Max Pain 18 ｜ Put Wall 16（-0.6%）（OI 0.1k）
...
仓位参考: Max Pain 20 ｜ Put Wall 15（-6.8%，弱）（OI 0.6k）
