...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 5,278,094 | GEX Change vs 上次快照 -16,807,293 | Flip: Primary Flip: 143.04（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 正 Gamma（528万，无历史分位）｜正 Gamma 减弱（1681万）｜现价位于 Flip 上方 0.31%｜⚠️ 重点观察：正 Gamma 由正转负（结构切换）——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
存量OI: C 658.3k / P 537.4k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $3.54 / P $2.96 ｜ ATM IV 62.5%，净 delta 敞口 0 shares
仓位参考: Max Pain 145 ｜ Call Wall 155（+8.0%，弱）（OI 58.3k） ｜ Put Wall 150（+4.5%，弱）（OI 46.1k）
量化解读： 存量 Call 重｜ATM IV 62.5%｜历史 Rank 55%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

09-25（Activity LOW）仓位参考: Max Pain 146 ｜ Call Wall 155（+8.0%，弱）（OI 5.2k） ｜ Put Wall 134（-6.6%，弱）（OI 5.2k）

10-02（Activity LOW）仓位参考: Max Pain 145 ｜ Call Wall 150（+4.5%，弱）（OI 3.0k）

10-09（Activity LOW）仓位参考: Max Pain 147 ｜ Call Wall 150（+4.5%，弱）（OI 0.8k） ｜ Put Wall 135（-5.9%）（OI 2.9k）
