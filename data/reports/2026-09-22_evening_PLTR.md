...
Options: P/C成交量 0.54 | OI比 0.72 | ATM IV 49.5% | Skew 1.5pp | Term 0.93 | ExpMove ±3.6%（近端） | Rank 27%
量化视角： IV 中性（Rank 27%）｜期限结构正常（Term 0.93）｜保护溢价薄（Skew 1.5pp）｜存量 Call 偏重（OI比 0.72）——观察点，非方向信号
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 87,960,380 | GEX Change vs 上次快照 12,308,460 | Flip: Primary Flip: 171.88（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 正 Gamma（8796万，无历史分位）｜正 Gamma 增强（+1231万）｜现价位于 Flip 上方 7.62%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
量化解读： 存量 Call 重｜ATM IV 49.5%｜历史 Rank 27%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

10-02（Activity LOW）仓位参考: Max Pain 175 ｜ Call Wall 200（+8.1%，弱）（OI 4.3k） ｜ Put Wall 170（-8.1%）（OI 5.7k）

10-09（Activity LOW）仓位参考: Max Pain 175 ｜ Call Wall 177.5（-4.0%，弱）（OI 3.1k） ｜ Put Wall 170（-8.1%，弱）（OI 3.9k）

10-16（Activity LOW）仓位参考: Max Pain 160 ｜ Call Wall 170（-8.1%，弱）（OI 15.5k） ｜ Put Wall 170（-8.1%，弱）（OI 14.9k）
