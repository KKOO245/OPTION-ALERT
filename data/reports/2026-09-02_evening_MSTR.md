...
09-04  C +6.8k / P +3.4k ｜ Activity MEDIUM △ ｜ 2D
09-11  C +2.8k / P +2.5k ｜ Activity HIGH ｜ 9D
09-18  C -0.4k / P +3.8k ｜ Activity HIGH ｜ 16D
...
C 131 ｜ +2,579 ｜ $0.70 ｜ 名义 $180.5k* ｜ +6.3%
C 128 ｜ +1,413 ｜ $1.22 ｜ 名义 $172.4k* ｜ +3.9%
C 129 ｜ +1,314 ｜ $1.00 ｜ 名义 $131.4k* ｜ +4.7%
结构参考：131（+6.3%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜ATM IV 76.8%｜历史 Rank 43%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 111,299 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-11 Forward Structure
存量OI:      C 39.2k / P 74.2k
今日变化ΔOI: C +2.8k / P +2.5k
平值价格ATM:  C 5.08 / P 4.95
隐含波动率 ATM IV:  64.7%
净 delta 敞口变化 ΔOI Δ Exposure*: -42k shares
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Put 重｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 64.7%｜历史 Rank 43%（近端代理）｜净 delta 敞口 负 42,368 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-18 Forward Structure
存量OI:      C 267.7k / P 186.9k
今日变化ΔOI: C -0.4k / P +3.8k
平值价格ATM:  C 6.97 / P 6.67
隐含波动率 ATM IV:  66.2%
净 delta 敞口变化 ΔOI Δ Exposure*: -58k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 110 ｜ +853 ｜ $1.90 ｜ 名义 $162.1k* ｜ -10.7%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：110（-10.7%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 66.2%｜历史 Rank 43%（近端代理）｜净 delta 敞口 负 58,404 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-25 Forward Structure
存量OI:      C 16.5k / P 23.2k
今日变化ΔOI: C +0.9k / P +1.6k
平值价格ATM:  C 8.25 / P 8.26
隐含波动率 ATM IV:  67.1%
净 delta 敞口变化 ΔOI Δ Exposure*: -4k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 133 ｜ +694 ｜ $4.65 ｜ 名义 $322.7k* ｜ +8.0%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：133（+8.0%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Put 重｜ATM IV 67.1%｜历史 Rank 43%（近端代理）｜净 delta 敞口 负 3,973 股（方向不可观测）——方向不可观测，观察点，非方向信号
