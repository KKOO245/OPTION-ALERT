...
CCO: 今开 2.35 → 收盘 2.37（+0.9%） ｜ 今日高 2.38 ｜ 低 2.34
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 26,787 | GEX Change vs 上次快照 -843 | Flip: Candidates 2.21 ｜ Primary: N/A（CONDITIONAL）
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-31/CCO_evening.json