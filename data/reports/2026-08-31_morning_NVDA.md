...
🟡 **近现价集中开仓**: 09-02 230C ΔOI +5,422（距现价 +4.7%）
...
NVDA  昨收 217.55 → 今晨 219.74（+1.0%） | 较昨收变动（含盘初走势） ｜ 今日高 220.60 ｜ 低 216.21

Options: P/C量 0.74 | OI比 0.53 | ATM IV 35.9% | Skew -1.0pp | Term 0.87 | ExpMove ±2.0%（近端） | Rank 21%
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 468,987,964 | GEX Change N/A | Flip: Primary Flip: 210.61（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 97%（带内） ｜ IV 有效性: VALID 634 / LOW 219 / INVALID 483
结构观察区: Primary Flip 210.61（全链重定价，覆盖 97%）
Put Wall 200（弱结构｜现价高于该位 9.9%） | Call Wall 240（弱结构｜现价低于该位 8.4%）
最近结构参考: Flip 211（现价高于该位 4.3%）
🧭 结构解读（全部依赖上方假设）
• 支撑/压力参考：下方 200（Put Wall，弱结构）；上方 240（Call Wall，弱结构）。
• Gamma 区域：切换参考 211（全链重定价，覆盖 97%）。
...
ATM:      C 2.09 / P 2.30
ATM IV:   32.8%
ΔOI Δ Exposure*: 414k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 190 ｜ +6,215 ｜ $0.04 ｜ 名义 $24.9k* ｜ -13.5%
C 230 ｜ +5,422 ｜ $0.16 ｜ 名义 $86.8k* ｜ +4.7%
C 220 ｜ +4,153 ｜ $2.09 ｜ 名义 $868.0k* ｜ +0.1%
结构参考：230（+4.7%）上方 / 190（-13.5%）下方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 235 ｜ -57,389 ｜ $0.20 ｜ 名义 $-1.15M* ｜ +6.9%
C 245 ｜ -53,597 ｜ $0.06 ｜ 名义 $-321.6k* ｜ +11.5%
P 190 ｜ -37,427 ｜ $0.07 ｜ 名义 $-262.0k* ｜ -13.5%
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
ATM:      C 4.04 / P 4.08
ATM IV:   29.1%
ΔOI Δ Exposure*: 570k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 240 ｜ +65,132 ｜ $0.23 ｜ 名义 $1.50M* ｜ +9.2%
C 250 ｜ +5,329 ｜ $0.09 ｜ 名义 $48.0k* ｜ +13.8%
C 235 ｜ +1,972 ｜ $0.46 ｜ 名义 $90.7k* ｜ +6.9%
结构参考：240（+9.2%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
ATM:      C 4.60 / P 4.70
ATM IV:   30.5%
ΔOI Δ Exposure*: 155k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 230 ｜ +5,436 ｜ $1.34 ｜ 名义 $728.4k* ｜ +4.7%
P 130 ｜ +5,069 ｜ $0.02 ｜ 名义 $10.1k* ｜ -40.8%
P 200 ｜ +2,586 ｜ $0.40 ｜ 名义 $103.4k* ｜ -9.0%
结构参考：230（+4.7%）上方 / 130（-40.8%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
