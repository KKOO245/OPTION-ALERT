...
Options: P/C成交量 0.67 | OI比 0.74 | ATM IV 42.4% | Skew -2.6pp | Term 1.06 | ExpMove ±1.8%（近端） | Rank 14%
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 146,400,394 | GEX Change vs 上次快照 30,445,191 | Flip: Primary Flip: 358.73（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 100%（带内） ｜ IV 有效性: VALID 1250 / LOW 108 / INVALID 478
结构观察区: Primary Flip 358.73（全链重定价，覆盖 100%）
Call Wall 400（弱结构｜现价低于该位 5.3%）
最近结构参考: Call Wall 400（现价低于该位 5.3%）
量化视角： 正 Gamma（1.46亿，无历史分位）｜正 Gamma 增强（+3045万）｜现价位于 Flip 上方 5.62%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
存量OI: C 54.6k / P 40.5k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $2.84 / P $4.00 ｜ ATM IV 42.4%，净 delta 敞口 0 shares
仓位参考: Max Pain 370 ｜ Call Wall 400（+5.6%，弱）（OI 5.9k） ｜ Put Wall 370（-2.3%，弱）（OI 3.0k）
量化解读： 存量 Call 重｜ATM IV 42.4%｜历史 Rank 14%（近端代理）｜IV/RV 0.98×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

09-25（Activity LOW）仓位参考: Max Pain 362 ｜ Call Wall 367.5（-3.0%，弱）（OI 16.5k）

09-28（Activity LOW）仓位参考: Max Pain 368 ｜ Call Wall 410（+8.2%，弱）（OI 1.4k） ｜ Put Wall 375（-1.0%，弱）（OI 0.8k）

09-30（Activity LOW）仓位参考: Max Pain 368 ｜ Call Wall 400（+5.6%，弱）（OI 0.8k） ｜ Put Wall 370（-2.3%，弱）（OI 0.6k）
