...
🟡 **近现价集中开仓**: 09-11 175C ΔOI +4,137（距现价 +0.3%）
...
PLTR  昨收 174.33 → 今开 180.01（+3.3%） | 较昨收变动（含盘初走势） ｜ 今日高 182.19 ｜ 低 173.67
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 39,746,841 | GEX Change vs 上次快照 21,589,592 | Flip: Primary Flip: 166.85（PRIMARY，全链重定价 + 覆盖达标）
...
Put Wall 170（弱结构｜现价高于该位 2.6%）
最近结构参考: Put Wall 170（现价高于该位 2.6%）
量化视角： 正 Gamma（3975万，无历史分位）｜正 Gamma 增强（+2159万）｜现价位于 Flip 上方 4.53%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
C 187 ｜ +4,874 ｜ $0.58 ｜ 名义 $282.7k* ｜ +7.5%
C 175 ｜ +4,137 ｜ $3.69 ｜ 名义 $1.53M* ｜ +0.3%
C 180 ｜ +2,725 ｜ $1.85 ｜ 名义 $504.1k* ｜ +3.2%
结构参考：187（+7.5%）附近形成 OI 变化集中（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 160 ｜ +3,754 ｜ $1.40 ｜ 名义 $525.6k* ｜ -8.3%
（已过滤 2 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：160（-8.3%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
P 160 ｜ +1,162 ｜ $3.21 ｜ 名义 $373.0k* ｜ -8.3%
P 157 ｜ +1,043 ｜ $2.70 ｜ 名义 $281.6k* ｜ -9.7%
结构参考：177（+1.8%） / 160（-8.3%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 175（结算参考） ｜ Call Wall 180（+3.2%，弱）（OI 2.4k） ｜ Put Wall 160（-8.3%，弱）（OI 2.8k）
量化解读： 存量 Put 重｜ATM IV 45.1%｜净 delta 敞口 正 76,483 股（方向不可观测）——方向不可观测，观察点，非方向信号

数据质量: 行情 A ｜ 期权结构 A ｜ 流向 C ｜ 做市商机制 C —— Flow 相关层（Activity 连续性、做市商机制解读）置信度受限。
Setup: 今日无 Setup 触发（机械检查全部 Setup）

数据溯源：完整表见附录 / thesis / analytics/daily/2026-09-07/PLTR_morning.json