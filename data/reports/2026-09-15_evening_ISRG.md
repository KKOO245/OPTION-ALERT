...
🔍 重点速览
🟡 **近现价集中开仓**: 09-18 385C ΔOI +90（距现价 +2.1%）
...
Options: P/C成交量 1.60 | OI比 0.92 | ATM IV 38.5% | Skew 10.3pp | Term 0.95 | ExpMove ±3.4%（近端） | Rank 40%
量化视角： IV 中性（Rank 40%）｜期限结构正常（Term 0.95）｜保护溢价显著（Skew 10.3pp，Put 明显贵于 Call）｜当日成交偏 Put（P/C量 1.60）——观察点，非方向信号
   ⇒ Put/Call Volume: 1.60×（Put 成交量高于 Call）→ 方向 Unknown
   ⇒ Put/Call OI: 0.92×（两侧接近均衡）
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Put，存量接近均衡
   ExpMove 期限化（expmove_v1）: 09-18（3D）±3.4% ｜ 09-25（10D）±2.7% ｜ 10-02（17D）±3.0% ｜ 10-09（24D）±7.4%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: NEGATIVE（模型分类） | GEX(存量) -516,993 | GEX Change vs 上次快照 1,987,457 | Flip: Primary Flip: 378.82（PRIMARY，全链重定价 + 覆盖达标）
...
最近结构参考: Flip 379（现价低于该位 0.4%）
量化视角： 负 Gamma（52万，无历史分位）｜负 Gamma 缓解（+199万）｜现价位于 Flip 下方 0.44%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
存量OI: C 16.4k / P 15.0k，今日变化ΔOI: C +0.4k / P -1.3k，平值价格ATM: C $6.40 / P $6.54 ｜ ATM IV 38.5%，净 delta 敞口 -4k shares
Top ΔOI: C 385 +90 ｜ C 392 +81
仓位参考: Max Pain 372 ｜ Call Wall 400（+6.1%，弱）（OI 1.1k） ｜ Put Wall 350（-7.2%，弱）（OI 2.4k）
量化解读： 存量两侧均衡｜ATM IV 38.5%｜历史 Rank 40%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 3,842 股

📆 09-25 Forward Structure
存量OI: C 1.5k / P 0.8k，今日变化ΔOI: C +84 / P +27，平值价格ATM: C $10.03 / P $0.00 ｜ ATM IV 33.2%，净 delta 敞口 788 shares
Top ΔOI: C 400 +30 ｜ C 380 +13 ｜ P 355 -11
仓位参考: Max Pain 370 ｜ Call Wall 405（+7.4%，弱）（OI 0.2k） ｜ Put Wall 360（-4.5%，弱）（OI 0.2k）
量化解读： 存量 Call 重｜ATM IV 33.2%｜历史 Rank 40%（近端代理）｜净 delta 敞口 正 788 股

10-02（MEDIUM △）Top ΔOI: 377C +5 ｜ 350P +4
10-02（MEDIUM △）仓位参考: Max Pain 365 ｜ Call Wall 405（+7.4%，弱）（OI 53）

10-09（MEDIUM △）Top ΔOI: 370C +8 ｜ 375C +3
10-09（MEDIUM △）仓位参考: Max Pain 350 ｜ Call Wall 380（+0.8%）（OI 0.1k） ｜ Put Wall 345（-8.5%，弱）（OI 16）

📅 事件差分（观察，非因果）: 09-18（3D）ATM IV 38.5% vs 09-25 33.2%（差 +5.3pp）——覆盖 零售销售 MoM、美联储利率决议 Decision、美联储议息会议 Economic Projections、Fed Press Conference、新屋开工、建筑许可 Prel
