...
🟡 **近现价集中开仓**: 09-04 18P ΔOI +1,640（距现价 -0.1%）
...
USAR  昨收 17.99 → 今晨 18.01（+0.1%） | 较昨收变动（含盘初走势） ｜ 今日高 18.19 ｜ 低 17.68
...
Options: P/C量 0.32 | OI比 0.29 | ATM IV 90.0% | Skew -4.1pp | Term 0.94 | ExpMove ±7.7%（近端） | Rank 6%
   ...
   ExpMove 期限化（expmove_v1）: 09-04（4D）±7.7% ｜ 09-11（11D）±11.1% ｜ 09-18（18D）±14.3% ｜ 09-25（25D）±17.3%
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 6,538,506 | GEX Change vs 上次快照 -36,405 | Flip: Primary Flip: 16.64（PRIMARY，全链重定价 + 覆盖达标）
...
P 18 ｜ +1,640 ｜ $0.70 ｜ 名义 $114.8k* ｜ -0.1%
P 16 ｜ +755 ｜ $0.16 ｜ 名义 $12.1k* ｜ -8.4%
C 18 ｜ +588 ｜ $0.69 ｜ 名义 $40.6k* ｜ -0.1%
结构参考：18（-0.1%）下方形成 OI 变化集中区（结构观察，非价格预测）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 25 ｜ +427 ｜ $0.05 ｜ 名义 $2.1k* ｜ +38.8%
C 18 ｜ +90 ｜ $1.00 ｜ 名义 $9.0k* ｜ -0.1%
P 18 ｜ +74 ｜ $1.19 ｜ 名义 $8.8k* ｜ +2.7%
结构参考：25（+38.8%）上方 / 18（-0.1%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 25 ｜ +898 ｜ $0.09 ｜ 名义 $8.1k* ｜ +38.8%
C 19 ｜ +253 ｜ $0.92 ｜ 名义 $23.3k* ｜ +5.5%
C 22 ｜ -216 ｜ $0.30 ｜ 名义 $-6.5k* ｜ +22.2%
结构参考：25（+38.8%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
