...
USAR  昨收 17.99 → 今晨 18.03（+0.2%） | 较昨收变动（含盘初走势） ｜ 今日高 18.19 ｜ 低 17.68
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 6,645,103 | GEX Change vs 上次快照 70,192 | Flip: Primary Flip: 16.64（PRIMARY，全链重定价 + 覆盖达标）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 25 ｜ +427 ｜ $0.05 ｜ 名义 $2.1k* ｜ +38.7%
C 18 ｜ +90 ｜ $1.00 ｜ 名义 $9.0k* ｜ -0.2%
P 18 ｜ +74 ｜ $1.19 ｜ 名义 $8.8k* ｜ +2.6%
结构参考：25（+38.7%）上方 / 18（-0.2%）下方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
...
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 25 ｜ +898 ｜ $0.09 ｜ 名义 $8.1k* ｜ +38.7%
C 19 ｜ +253 ｜ $0.92 ｜ 名义 $23.3k* ｜ +5.4%
C 22 ｜ -216 ｜ $0.30 ｜ 名义 $-6.5k* ｜ +22.0%
结构参考：25（+38.7%）上方形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
