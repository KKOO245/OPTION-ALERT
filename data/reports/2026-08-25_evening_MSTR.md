...
MSTR: 今晨 124.21 → 收盘 125.76（+1.2%） ｜ 今日高 128.66 ｜ 低 118.45
Target 状态: PENDING（evaluation date …）——窗口结束前禁止'预测正确'类措辞


## MSTR

Options: P/C量 0.83 | OI比 0.80 | ATM IV 87.0% | Skew -7.0pp | Term 0.85 | ExpMove ±6.3% | Rank — (历史不足)
   ⇒ Put/Call Volume: 0.83×（Put 与 Call 成交量接近）→ 方向 Unknown
   ⇒ Put/Call OI: 0.80×（存量 Call 仓位高于 Put）→ 存量 Call-dominant
   ⇒ 当日成交 vs 存量仓位：当日成交接近均衡，存量Call-dominant
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: POSITIVE（模型分类） | GEX(存量) N/A | GEX Change N/A | Flip: ≈114.29 / ≈114.34 / ≈129.56
结构观察区: 114–114（局部 Gamma 切换，低置信；Top-3 近似，需全链重定价验证）
距 Put Wall 60: +109.6% | 距 Call Wall 100: +25.8%
🧭 结构解读（全部依赖上方假设）
...
数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-25/MSTR_evening.json