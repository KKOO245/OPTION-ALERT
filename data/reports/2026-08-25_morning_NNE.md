...
NNE  昨收 18.30 → 今晨 18.36（+0.3%） | 较昨收变动（含盘初走势） ｜ 今日高 18.66 ｜ 低 18.10
...
• Gamma 区域：切换参考 11（Top-3 近似，需全链重定价验证）。
• 做市商（条件机制）：若 Scenario A + 负 Gamma 成立，跌破关键位下方可能对应顺周期卖出压力增加；实际做市商对冲流量不可观测。Scenario B → 方向相反。不进入方向决策。
• 失效参考：跌破关键位结构参考失效（结构性参考，非预测）。
🔺 Activity（事实层，方向 Unknown）
09-25 22.5C — Vol N/A | OI 21→3022 (ΔOI +3001张) | ΔOI/Volume N/A | Magnitude: HIGH | 完整度: LOW
   ⇒ 大额净增3001张（+14290.5% vs前日OI），连续性待观察（方向未知）
09-11 24.0C — Vol N/A | OI 82→1024 (ΔOI +942张) | ΔOI/Volume N/A | Magnitude: HIGH | 完整度: LOW
   ⇒ 大额净增942张（+1148.8% vs前日OI），连续性待观察（方向未知）
09-04 16.0P — Vol N/A | OI 31→311 (ΔOI +280张) | ΔOI/Volume N/A | Magnitude: MEDIUM | 完整度: LOW
   ⇒ 净增280张（+903.2% vs前日OI），值得跟踪（方向未知）
09-18 20.0C — Vol N/A | OI 268→469 (ΔOI +201张) | ΔOI/Volume N/A | Magnitude: MEDIUM | 完整度: LOW
   ⇒ 净增201张（+75.0% vs前日OI），值得跟踪（方向未知）
08-28 17.0P — Vol N/A | OI 147→286 (ΔOI +139张) | ΔOI/Volume N/A | Magnitude: MEDIUM | 完整度: LOW
   ⇒ 净增139张（+94.6% vs前日OI），值得跟踪（方向未知）
Setup: 今日无 Setup 触发（机械检查全部 Setup）

数据溯源：完整表见附录 / thesis / analytics/daily/2026-08-25/NNE_morning.json