...
GDX  昨收 94.67 → 今开 96.96（+2.4%） | 较昨收变动（含盘初走势） ｜ 今日高 98.76 ｜ 低 96.94

Options: P/C成交量 0.49 | OI比 0.89 | ATM IV 52.8% | Skew 0.3pp | Term 0.86 | ExpMove ±3.2%（近端） | Rank 87%
量化视角： IV 历史高位（Rank 87%，期权偏贵）｜期限结构倒挂（Term 0.86，近月 IV 高于远月）｜保护溢价薄（Skew 0.3pp）｜当日成交与存量接近均衡——观察点，非方向信号
   ⇒ Put/Call Volume: 0.49×（Call 成交量高于 Put）→ 方向 Unknown
   ⇒ Put/Call OI: 0.89×（两侧接近均衡）
   ⇒ 当日成交 vs 存量仓位：当日成交偏 Call，存量接近均衡
   ExpMove 期限化（expmove_v1）: 09-04（2D）±3.2% ｜ 09-11（9D）±6.1% ｜ 09-18（16D）±7.8% ｜ 09-25（23D）±8.8%
   ⇒ IV–VIX Spread: +37.4pp*（*近月 ATM IV − VIX；期限未对齐，仅作相对波动率 Proxy，不直接代表期权定价贵/便宜）
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: NEGATIVE（模型分类） | GEX(存量) -14,900,957 | GEX Change vs 上次快照 22,899,274 | Flip: Primary Flip: 98.31（PRIMARY，全链重定价 + 覆盖达标）
🔎 测量完整性: GEX 符号契约 gex_sign_v1（Model A: Call+ / Put−）｜ Gamma 口径 全链重定价 ｜ Effective GEX 覆盖: 99%（带内） ｜ IV 有效性: VALID 599 / LOW 168 / INVALID 209
   ⇒ 全链负Gamma，波动易被放大（模型层）
结构观察区: Primary Flip 98.31（全链重定价，覆盖 99%）
Call Wall 100（弱结构｜现价低于该位 2.5%）
最近结构参考: Flip 98（现价低于该位 0.9%）
量化视角： 负 Gamma（1490万，无历史分位）｜负 Gamma 缓解（+2290万）｜现价位于 Flip 下方 0.86%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
平值价格ATM:  C 1.91 / P 1.20
隐含波动率 ATM IV:  52.8%
净 delta 敞口变化 ΔOI Δ Exposure*: 407k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 93 ｜ +4,863 ｜ $0.29 ｜ 名义 $141.0k* ｜ -4.6%
C 104 ｜ -4,351 ｜ $0.13 ｜ 名义 $-56.6k* ｜ +6.7%
C 103 ｜ +3,612 ｜ $0.21 ｜ 名义 $75.9k* ｜ +5.7%
结构参考：103（+5.7%） / 93（-4.6%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量两侧均衡｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 52.8%｜历史 Rank 87%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 406,992 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-11 Forward Structure
存量OI:      C 20.1k / P 36.3k
今日变化ΔOI: C +4.2k / P +10.5k
平值价格ATM:  C 3.45 / P 2.47
隐含波动率 ATM IV:  44.9%
净 delta 敞口变化 ΔOI Δ Exposure*: -10k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 90 ｜ +4,841 ｜ $0.48 ｜ 名义 $232.4k* ｜ -7.7%
C 100 ｜ +3,548 ｜ $1.73 ｜ 名义 $613.8k* ｜ +2.6%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：100（+2.6%） / 90（-7.7%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量 Put 重｜ATM IV 44.9%｜历史 Rank 87%（近端代理）｜净 delta 敞口 负 9,712 股（方向不可观测）——方向不可观测，观察点，非方向信号
...
平值价格ATM:  C 4.60 / P 3.95
隐含波动率 ATM IV:  45.2%
净 delta 敞口变化 ΔOI Δ Exposure*: 10k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 110 ｜ +499 ｜ $1.10 ｜ 名义 $54.9k* ｜ +12.9%
P 92 ｜ +157 ｜ $1.95 ｜ 名义 $30.6k* ｜ -5.6%
C 105 ｜ +121 ｜ $2.04 ｜ 名义 $24.7k* ｜ +7.7%
结构参考：110（+12.9%） / 92（-5.6%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
量化解读： 存量两侧均衡｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 45.2%｜历史 Rank 87%（近端代理）｜净 delta 敞口 正 9,903 股（方向不可观测）——方向不可观测，观察点，非方向信号

📅 事件差分（观察，非因果）: 09-04（2D）ATM IV 52.8% vs 09-11 44.9%（差 +8.0pp）——覆盖 ISM 非制造业 PMI、Non Farm Payrolls、失业率
