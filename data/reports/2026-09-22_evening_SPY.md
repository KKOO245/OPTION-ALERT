...
Options: P/C成交量 0.95 | OI比 0.92 | ATM IV 9.4% | Skew 0.5pp | Term 1.25 | ExpMove ±0.4%（近端） | Rank 20%
...
Gamma Regime: POSITIVE（模型分类） | GEX(存量) 699,084,066 | GEX Change vs 上次快照 -249,454,915 | Flip: Primary Flip: 769.53（PRIMARY，全链重定价 + 覆盖达标）
...
量化视角： 正 Gamma（6.99亿，历史分位 70%，中性区）｜正 Gamma 减弱（2.49亿）｜现价位于 Flip 上方 0.50%｜⚠️ 重点观察：正 Gamma 由正转负（结构切换）——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
存量OI: C 135.1k / P 124.0k，今日变化ΔOI: C +0 / P +0，平值价格ATM: C $1.86 / P $1.21 ｜ ATM IV 9.4%，净 delta 敞口 0 shares
仓位参考: Max Pain 770 ｜ Call Wall 780（+0.9%）（OI 16.6k） ｜ Put Wall 770（-0.4%，弱）（OI 7.5k）
量化解读： 存量两侧均衡｜ATM IV 9.4%｜历史 Rank 20%（近端代理）｜IV/RV 0.92×（近似）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 0 股

09-24（Activity LOW）仓位参考: Max Pain 764 ｜ Call Wall 771（-0.3%）（OI 5.4k） ｜ Put Wall 752（-2.8%，弱）（OI 3.1k）
