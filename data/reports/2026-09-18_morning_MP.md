...
🔍 重点速览
🟡 **近现价集中开仓**: 09-25 50C ΔOI +216（距现价 +3.8%）
...
Options: P/C成交量 1.91 | OI比 0.63 | ATM IV 78.8% | Skew -15.7pp | Term 0.75 | ExpMove ±7.8%（近端） | Rank 69%
量化视角： IV 中性（Rank 69%）｜期限结构倒挂（Term 0.75，近月 IV 高于远月）｜Put 保护异常便宜（Skew -15.7pp，Put IV < Call IV）｜⚠️ 重点观察：存量 Call 重（OI比 0.63）+ 当日成交偏 Put（P/C量 1.91）——结构背离，买/卖方向不可观测——观察点，非方向信号
   ...
   ExpMove 期限化（expmove_v1）: 09-25（7D）±7.8% ｜ 10-02（14D）±11.0% ｜ 10-09（21D）±5.6% ｜ 10-16（28D）±13.7%
   ⇒ IV–VIX Spread: +63.3pp*（*近月 ATM IV − VIX；期限未对齐，仅作相对波动率 Proxy，不直接代表期权定价贵/便宜）
🔧 结构（未验证研究层：Mechanism Scenario A/B——OI 开仓方向不可观测）
Gamma Regime: NEGATIVE（模型分类） | GEX(存量) -7,868,037 | GEX Change vs 上次快照 847,772 | Flip: Primary Flip: 51.23（PRIMARY，全链重定价 + 覆盖达标）
...
Put Wall 45（弱结构｜现价高于该位 7.0%）
最近结构参考: Flip 51（现价低于该位 6.0%）
量化视角： 负 Gamma（787万，无历史分位）｜负 Gamma 缓解（+85万）｜现价位于 Flip 下方 5.99%——观察点，非方向信号
🧭 结构解读（全部依赖上方假设）
...
🎯 今日到期（0DTE）
存量OI: C 53.6k / P 33.7k，今日成交量: C 3.0k / P 5.8k，平值价格ATM: C $1.81 / P $0.18 ｜ ATM IV 78.8%，预期波动 ±4.1%，Max Pain 50
...
存量OI: C 7.2k / P 7.3k，今日变化ΔOI: C +1.2k / P +0.5k，平值价格ATM: C $2.78 / P $0.96 ｜ ATM IV 56.8%，净 delta 敞口 33k shares
Top ΔOI: C 50 +216 ｜ P 47 +197
仓位参考: Max Pain 52 ｜ Call Wall 50（+3.8%，弱）（OI 0.4k） ｜ Put Wall 50（+3.8%，弱）（OI 0.5k）
量化解读： 存量两侧均衡｜⚠️ 背离：存量 Put 重但当日 Call 增仓更多｜ATM IV 56.8%｜历史 Rank 69%（近端代理）｜IV/RV 1.62×（近似）｜净 delta 敞口 正 32,547 股

📆 10-02 Forward Structure
存量OI: C 4.5k / P 3.6k，今日变化ΔOI: C +1.1k / P +0.2k，平值价格ATM: C $3.70 / P $1.60 ｜ ATM IV 58.5%，净 delta 敞口 49k shares
Top ΔOI: C 49 +849 ｜ P 48 +161 ｜ P 46 +114
仓位参考: Max Pain 52 ｜ Call Wall 49（+1.7%，弱）（OI 0.9k） ｜ Put Wall 50（+3.8%）（OI 1.3k）
量化解读： 存量 Call 重｜ATM IV 58.5%｜历史 Rank 69%（近端代理）｜IV/RV 1.67×（近似）｜净 delta 敞口 正 49,373 股
...
仓位参考: Max Pain 52 ｜ Put Wall 47（-2.4%）（OI 1.1k）
量化解读： 存量 Call 重｜ATM IV 57.8%｜历史 Rank 69%（近端代理）｜IV/RV 1.65×（近似）｜净 delta 敞口 负 1,962 股
...
仓位参考: Max Pain 55 ｜ Call Wall 50（+3.8%，弱）（OI 2.3k） ｜ Put Wall 45（-6.6%，弱）（OI 2.9k）
量化解读： 存量 Call 重｜ATM IV 59.4%｜历史 Rank 69%（近端代理）｜IV/RV 1.70×（近似）｜净 delta 敞口 正 61,003 股
