...
平值价格ATM:  C 0.50 / P 0.94
隐含波动率 ATM IV:  30.4%
净 delta 敞口变化 ΔOI Δ Exposure*: 39k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 58 ｜ +1,578 ｜ $0.41 ｜ 名义 $64.7k* ｜ -1.1%
C 63 ｜ +1,257 ｜ $0.03 ｜ 名义 $3.8k* ｜ +7.5%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：63（+7.5%） / 58（-1.1%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 59（结算参考） ｜ Put Wall 58（-1.1%）（OI 2.5k）
量化解读： 存量 Call 重｜ATM IV 30.4%｜历史 Rank 81%（近端代理）｜期限正常（远月高于近端）｜净 delta 敞口 正 39,384 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-16 Forward Structure
存量OI:      C 7.5k / P 8.8k
今日变化ΔOI: C +1.4k / P +5.1k
平值价格ATM:  C 0.95 / P 1.41
隐含波动率 ATM IV:  39.6%
净 delta 敞口变化 ΔOI Δ Exposure*: -116k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 58 ｜ +3,582 ｜ $0.81 ｜ 名义 $290.1k* ｜ -1.1%
P 57 ｜ +524 ｜ $0.50 ｜ 名义 $26.2k* ｜ -2.8%
（已过滤 1 条低相关性彩票：名义 <$50k 且距现价 >10%）
结构参考：58（-1.1%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 60（结算参考） ｜ Call Wall 64（+9.2%）（OI 1.8k） ｜ Put Wall 58（-1.1%）（OI 3.9k）
量化解读： 存量两侧均衡｜ATM IV 39.6%｜历史 Rank 81%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 负 116,049 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-18 Forward Structure
存量OI:      C 962.1k / P 461.2k
今日变化ΔOI: C -5.4k / P -2.1k
平值价格ATM:  C 1.45 / P 1.30
隐含波动率 ATM IV:  41.8%
净 delta 敞口变化 ΔOI Δ Exposure*: 706k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
C 63 ｜ -10,084 ｜ $0.27 ｜ 名义 $-272.3k* ｜ +7.5%
P 80 ｜ -3,877 ｜ $21.88 ｜ 名义 $-8.48M* ｜ +36.4%
C 60 ｜ +2,999 ｜ $0.80 ｜ 名义 $239.9k* ｜ +2.3%
结构参考：60（+2.3%）附近形成 OI 变化集中（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 60（结算参考）
量化解读： 存量 Call 重｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 41.8%｜历史 Rank 81%（近端代理）｜期限倒挂（近端 IV > 远月）｜净 delta 敞口 正 706,097 股（方向不可观测）——方向不可观测，观察点，非方向信号

📆 09-21 Forward Structure
存量OI:      C 1.3k / P 1.2k
今日变化ΔOI: C +0.4k / P +0.8k
平值价格ATM:  C 1.34 / P 1.79
隐含波动率 ATM IV:  38.9%
净 delta 敞口变化 ΔOI Δ Exposure*: -23k shares
Top ΔOI（行权价 ｜ ΔOI ｜ 最新价 ｜ 名义金额* ｜ 距现价）:
P 59 ｜ +298 ｜ $1.79 ｜ 名义 $53.3k* ｜ +0.6%
P 57 ｜ +219 ｜ $0.81 ｜ 名义 $17.7k* ｜ -2.8%
C 60 ｜ +97 ｜ $0.99 ｜ 名义 $9.6k* ｜ +2.3%
结构参考：59（+0.6%） / 57（-2.8%）形成 OI 变化集中区（结构观察，非价格预测）
*模型估算/名义金额代理；买开/卖开方向不可观测（Scenario A/B）
该期限仓位参考（Wall 同墙位口径，Max Pain 仅结算参考）: Max Pain 59（结算参考） ｜ Put Wall 59（+0.6%，弱）（OI 0.3k）
量化解读： 存量两侧均衡｜⚠️ 背离：存量 Call 重但当日 Put 增仓更多｜ATM IV 38.9%｜历史 Rank 81%（近端代理）｜净 delta 敞口 负 23,315 股（方向不可观测）——方向不可观测，观察点，非方向信号
